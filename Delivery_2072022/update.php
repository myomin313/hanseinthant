<?php
      ...
      $PL=$_GET['PL']; 
                ...
                VALUES ('$id','$okyaku','$OCustomer','$BrandName','$OBrandName','$Commodity','$OCommodity','$code','$Ocode','$Remark_item','$ORemark_Item','$Delivery_date','$ODelivery_date','$DO_No','$ODO_No','$JOB_No','$OJOB_No','$Qty','$OQty','$PL','$OPL','$Types','$OType','$Location','$OLocation','$RecordTime','$Recorder','$status')";
                //   echo $sql;
             mysqli_query($con ,$sql);      

                  $sql = " UPDATE delivery SET Customer ='$OCustomer',Location='$OLocation',Delivery_date='$ODelivery_date',DO_No ='$ODO_No',JOB_No ='$OJOB_No',BrandName ='$OBrandName',Commodity ='$OCommodity',code='$Ocode',Qty ='$OQty',Type ='$OType',Remark_item ='$Remark_item' WHERE id='$id'";  
                //   echo $sql;
