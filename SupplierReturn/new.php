...
function addRow(frm) {
  ...
  $.ajax({
   ...
   row = row+'<select name="BrandName[]" id="BrandName'+rowNum+'" style="width:20%;height:30px;"  autocomplete="off" required="required" onChange="showCommo(\''+rowNum+'\')" placeholder="Brand"/></select>';
...
<div id="outer-container" >
    <div id="scrollable">
        ...
        print '<tr><td style="width:8%;">Branch Name</td><td> <select name="Branch" id="Location" style="width:20%;height:30px;" onchange="showPL(this.value)" required="required">';
        print'<option value =""></option>';
