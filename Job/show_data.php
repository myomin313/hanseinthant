<?php
 ...
 while($row = mysqli_fetch_array($result)){
  ...
  print '<td  style="word-wrap:break-word;">' . $row['pbrandname'] . '</td>'; 
  print '<td >' . $row['ccommodity'] . '</td>';
  print '<td >' . $row['code_no'] . '</td>';
  print '<td style="width:4%;" >' . $row['WIP'] . '</td>';
  print '<td style="width:4%;background: #ffeb99;" >' . $row['balanceWIP'] . '</td>';
   print '<td style="width:4%;" >' . $row['balanceJOB'] . '</td>';
  ...
  print '<td  style="word-wrap:break-word;background:#ff9999;">' . $row['pbrandname'] . '</td>'; 
  print '<td style="background:#ff9999;">' . $row['ccommodity'] . '</td>';
  print '<td style="width:4%;background:#ff9999;" >' . $row['WIP'] . '</td>';
  print '<td style="width:4%;background: #ff9999;" >' . $row['balanceWIP'] . '</td>';
  print '<td style="width:4%;background: #ff9999;">'.$row['balanceJOB'].'</td>';
