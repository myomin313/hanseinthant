     ...
     // start myo min 
      include_once('../config.php');      
        ...
        foreach($_POST['Commodity'] as $row =>$Commodity) {             
           ...
           //11.8.2019 myo min
              $sqls = "SELECT * FROM job where Customer= '$oldCustomer' and Location= '$oldBranch' and BrandName = '$BrandName' and Commodity = '$Commoditys' and code='$code'";              
                 ...
                 VALUES ('$Oid','$okyaku','$OCustomer','$OBrandName','$OBrandName','$OCommodity','$OCommodity','$Ocode','$Ocode','$ORemarks_Item','$ORemarks_Item','$Job_date','$Job_date','$Job_No','$oldJOB_NO','$OProject','$OProject','$OWIP','$OWIP','$OType','$OType','$Location','$oldBranch','$OPL','$OPL','$RecordTime','$LUser','$status')";
                  mysqli_query($con ,$sqli);
                  $sqls = "SELECT * FROM delivery where Customer= '$oldCustomer' and Location= '$oldBranch' and BrandName = '$BrandName' and Commodity = '$Commoditys' and code='$code'";
                ...
                VALUES ('$Oid','$okyaku','$OCustomer','$OBrandName','$OBrandName','$OCommodity','$OCommodity','$Ocode','$Ocode','$ORemark_Item','$ORemark_Item','$ODelivery_date','$ODelivery_date','$ODO_No','$ODO_No','$Job_No','$OJOB_No','$OQty','$OQty','$OPL','$OPL','$OType','$OType','$Location','$OLocation','$RecordTime','$LUser','$status')";
            ...
            $sqld = " UPDATE delivery SET Customer ='$okyaku',Location ='$Location',Job_No ='$Job_No' WHERE Customer = '$oldCustomer' and Location = '$oldBranch' and BrandName = '$BrandName' and Commodity = '$Commoditys' and code='$code'";
             mysqli_query($con ,$sqld);

           $sqlr = " UPDATE returns SET Customer ='$okyaku',department ='$Location' WHERE Customer = '$oldCustomer' and department = '$oldBranch' and BrandName = '$BrandName' and Commodity = '$Commoditys' and code='$code'";
