              ...
              <tr class="tr_header" style="background-color:#3385ff;font-family:Tahoma, Geneva, sans-serif;font-size: 12px;">
                ...
                // echo $_POST['users'];
                  if (isset($_POST['users'])) {
                    ...
                    $sqls="SELECT *,b.brandname as brandname,c.commodity as commodity,co.code as code,coco.code as ocode,ob.brandname as obrandname,oc.commodity as ocommodity
                   FROM transfer_history
                   LEFT JOIN brandname b  ON transfer_history.BrandName= b.id 
                   LEFT JOIN commodity c  ON transfer_history.Commodity= c.id
                   LEFT JOIN code co  ON transfer_history.code= co.id
                   LEFT JOIN brandname ob ON transfer_history.OBrandName= ob.id 
                   LEFT JOIN commodity oc ON transfer_history.OCommodity= oc.id
                   LEFT JOIN code coco  ON transfer_history.code= coco.id
                    WHERE 1=1 ";
                  ...
                  if ($rowCount > 0) {
                    for($i=0;$i<$rowCount;$i++) {
                      ...
                      if ( $history <> '' && $i<=0){
                        $sqls =$sqls." AND transfer_no='" . $_POST["users"][$i] . "'";
                      ...
                      elseif ( $history <> '' || $i>0){
                        $sqls =$sqls." OR transfer_no='" . $_POST["users"][$i] . "'";
                      }
                    }
                  }
                  ...
                  if ($count > 0){                 
                    ...
                    print'<th class="checkall" rowspan="2" style="width:2%;"> 
                          ...
                          <th colspan="2">Transfer Date</th>
                          <th colspan="2">Transfer No</th>
                    ...
                    while($row = $results->fetch_assoc()){  
                      ...
                      if ($row['transfer_from'] != "" && $row['status'] == "Update") {
                        print '<td>'.$row['Otransfer_from'].'</td>';
                        print '<td><span style="color: #00cc44;">'.$row['transfer_from'].'</span></td>';
                      }
                      elseif ($row['transfer_from'] != "" && $row['status'] == "New") {
                          print '<td class="hide_right"><span style="color: blue;">'.$row['transfer_from'].'</span></td>';
                          print '<td></td>';
                      }                    
                      ...
                      else
                      {
                        ...
                        if ($row['status'] == "Delete") {
                          print '<td class="hide_right"><span style="color: #ff0036;">'.$row['Otransfer_from'].'</span></td>';
                          print '<td></td>';
                        }
                    ...
                    //     if ($row['OCustomer'] != "" && $row['status'] == "Delete") {
                    ...
                    //   } 
                      ...
                      //..............................//                     
                         ...
                         if ($row['transfer_date'] != "" && $row['status'] == "Update") {
                        print '<td>'.$row['Otransfer_date'].'</td>';
                        print '<td><span style="color: #00cc44;">'.$row['transfer_date'].'</span></td>';
                      }
                      elseif ($row['transfer_date'] != "" && $row['status'] == "New") {
                          print '<td class="hide_right"><span style="color: blue;">'.$row['transfer_date'].'</span></td>';
                          print '<td></td>';
                      }                    
                      ...
                      else
                      {
                        ...
                        if ($row['status'] == "Delete") {
                          print '<td class="hide_right"><span style="color: #ff0036;">'.$row['Otransfer_date'].'</span></td>';
                          print '<td></td>';
                        }

                      }             
                         //..............................//      
                         if ($row['transfer_no'] != "" && $row['status'] == "Update") {
                        print '<td>'.$row['Otransfer_no'].'</td>';
                        print '<td><span style="color: #00cc44;">'.$row['transfer_no'].'</span></td>';
                      }
                      elseif ($row['transfer_no'] != "" && $row['status'] == "New") {
                          print '<td class="hide_right"><span style="color: blue;">'.$row['transfer_no'].'</span></td>';
                          print '<td></td>';
                      }                    
                      ...
                      else
                      {
                        ...
                        if ($row['status'] == "Delete") {
                          print '<td class="hide_right"><span style="color: #ff0036;">'.$row['Otransfer_no'].'</span></td>';
                          print '<td></td>';
                        }
                     ...
                     //..............................//     
                            if ($row['transfer_to'] != "" && $row['status'] == "Update") {
                        print '<td>'.$row['Otransfer_to'].'</td>';
                        print '<td><span style="color: #00cc44;">'.$row['transfer_to'].'</span></td>';
                      }
                      elseif ($row['transfer_to'] != "" && $row['status'] == "New") {
                          print '<td class="hide_right"><span style="color: blue;">'.$row['transfer_to'].'</span></td>';
                          print '<td></td>';
                      }                    
                      ...
                      else
                      {
                        ...
                        if ($row['status'] == "Delete") {
                          print '<td class="hide_right"><span style="color: #ff0036;">'.$row['Otransfer_to'].'</span></td>';
                          print '<td></td>';
                        }
