...
// output headers so that the file is downloaded rather than displayed
 ...
 fputcsv($output,  array('id','Transfer No','Transfer Date','Transfer From','Transfer To','Code','BrandName','Commodity','Qty','Type','Remark_item','Transfer USD','PL','Creator','CreateTime'));
...
//           JOIN commodity ON delivery.Commodity= commodity.id"; 
   ...
   $sql="SELECT t.id as tid,t.transfer_no,t.transfer_date,bf.branch as branch_from,bt.branch as branch_to,co.code as code_no,brandname.brandname as BrandName,commodity.commodity as Commodity,t.Qty as Qty,t.Type as Type,t.Remark_item as remark,t.transferUSD as transferUSD,t.PL as PL,Creator,CreateTime FROM transfer t
