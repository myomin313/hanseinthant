...
<body style="font-size: 10px;font-family:Tahoma, Geneva, sans-serif;">
        ...
        print '<tr><td style="width:8%;">Branch Name</td><td> <select name="department" id="department" style="width:20%;height:30px;" onchange="showDo(this.value)" required="required">';
        print'<option value =""></option>';
