<?php
 ...
 while($row = mysqli_fetch_array($result)){
    ...
    $message="Edit";
     print '<td  class="actions"><a href="detail.php?SupplierID=' . $row['SupplierName'] .'&Branch=' . $row['Branch'].'&Packing_date=' . $row['Packing_date'].'&PL=' . urlencode($row['Purchase_order_No']). '" style="text-decoration: none;
    padding: 2px 5px;
    background: #2E8B57;
    color: white;
    ...
    print '<td>' . $row['Qty'] . '</td>';
    print '<td style="width:5px;background-color: #ffeb99;">' . $row['balanceTransfer'] . '</td>';
