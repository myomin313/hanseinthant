...
include_once('../config.php');
      ...
      $sqlproduct="SELECT * FROM product Where BrandName = '$OBrandName' and Commodity ='$OCommodity' and code='$Ocode' and Branch ='$transfer_from' and Purchase_order_No ='$OPL'";
      ...
      $sqluproduct = " UPDATE product SET  balanceTransfer ='$update_blancerTransfer', balanceQty='$update_balanceQty', currentQty='$update_currentQty', balanceUSD='$update_balanceUSD' Where BrandName = '$OBrandName' and Commodity ='$OCommodity' and code='$Ocode' and Branch ='$transfer_from' and Purchase_order_No ='$OPL'";
      mysqli_query($con ,$sqluproduct);


      $sqlddelete="DELETE FROM product WHERE branch='$transfer_to' and  Purchase_order_No='$OPL' and BrandName ='$OBrandName' and Commodity='$OCommodity' and code='$Ocode'";
