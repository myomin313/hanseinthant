...
include_once('../config.php');
      ...
      $PL=$_GET['PL']; 
            ...
            $sqlS = "SELECT Distinct Customer,Commodity,BrandName,PL  FROM delivery WHERE PL ='$transfer_no' and Commodity ='$Commodity' and BrandName ='$BrandName' and code='$code'";
      ...
      $sqlproduct="SELECT * FROM product Where BrandName = '$BrandName' and Commodity ='$Commodity' and code='$code' and Branch ='$transfer_from' and Purchase_order_No ='$PL'";
      ...
      $sqluproduct = " UPDATE product SET  balanceTransfer ='$update_blancerTransfer', balanceQty='$update_balanceQty', currentQty='$update_currentQty', balanceUSD='$update_balanceUSD' Where BrandName = '$BrandName' and Commodity ='$Commodity' and code='$code' and Branch ='$transfer_from' and Purchase_order_No ='$PL'";
      mysqli_query($con ,$sqluproduct);


      $sqlddelete="DELETE FROM product WHERE branch='$transfer_to' and  Purchase_order_No='$PL' and BrandName ='$BrandName' and Commodity='$Commodity' and code='$code'";
