      ...
      $ids=$_GET['ids'];
              ...
              foreach($idarray as $id) { 
                ...
                //   echo $sql;                  
                  ...
                  $sqlproduct="SELECT balanceReturn,USD,balanceUSD,balanceDelivery,balanceWIP,Qty FROM product Where BrandName = '$OBrandName' and code='$Ocode' and Commodity ='$OCommodity' and Branch ='$department' and Purchase_order_No ='$OPL'";

                  $resultproduct=mysqli_query($con ,$sqlproduct); 
                  $product = $resultproduct->fetch_assoc();
                  $balanceReturn = $product['balanceReturn'] - $OQty;

                 $sql = " UPDATE product SET  balanceReturn ='$balanceReturn' Where BrandName = '$OBrandName' and Commodity ='$OCommodity' and code='$Ocode' and Branch ='$department' and Purchase_order_No ='$OPL'";               
                 // echo $sql;
                 mysqli_query($con ,$sql); 
                 
                  $sqlproductA="SELECT balanceTransfer,balanceReturn,USD,balanceUSD,balanceDelivery,balanceWIP,Qty FROM product Where BrandName = '$OBrandName' and Commodity ='$OCommodity' and code='$Ocode' and Branch ='$department' and Purchase_order_No ='$OPL'";
                 ...
                 $sql = " UPDATE product SET balanceUSD='$balanceUSD',balanceQty='$totalQty' Where BrandName = '$OBrandName' and Commodity ='$OCommodity' and code='$Ocode' and Branch ='$department' and Purchase_order_No ='$OPL'";
                 // echo $sql;
                 mysqli_query($con ,$sql); 
                 
                   $sqlA = " UPDATE product SET currentQty='$currentQty' Where BrandName = '$OBrandName' and Commodity ='$OCommodity' and code='$Ocode' and Branch ='$department' and Purchase_order_No ='$OPL'";
             
                 mysqli_query($con ,$sqlA); 
                 
                $sqldelivery="SELECT returnQty FROM delivery Where BrandName = '$OBrandName' and Commodity ='$OCommodity' and code='$Ocode' and Location ='$department'  and PL ='$OPL' and DO_No = '$DO_No'";
                $resultdelivery=mysqli_query($con ,$sqldelivery); 
                $delivery = $resultdelivery->fetch_assoc();
                $returnQty = $delivery['returnQty'] - $OQty;

                 $sql = " UPDATE delivery SET  returnQty ='$returnQty' Where BrandName = '$OBrandName' and Commodity ='$OCommodity' and code='$Ocode' and Location ='$department' and PL ='$OPL' and DO_No = '$DO_No'";
                 // echo $sql;
                 mysqli_query($con ,$sql); 
