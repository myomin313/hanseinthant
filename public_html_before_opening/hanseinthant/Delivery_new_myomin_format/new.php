         ...
         if ($Branches == "Shwe Pyi Thar Store") {
          ...
          elseif ($Branches == "Naypyidaw Show Room") {
              print '<tr><td style="width:8%;">Branch</td><td>
                          ...
                          print '<tr><td>DO.No</td><td> <input type="text"  name="DO_No" id="DO_No" value=""  style="width:10%;height:30px;" required="required" onkeypress="return isNumberKey(event)" onKeyUp="checkDo()"/>';
