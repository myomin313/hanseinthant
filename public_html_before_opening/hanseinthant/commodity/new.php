...
<body style="font-size: 11px;font-family:Tahoma, Geneva, sans-serif;">
             ...
             <?php
                          ...
                          print '<tr><td>Commodity</td><td> <input type="text" name="commodity" id="commodity" onblur="fncClearBox()" onKeyUp="commodity()" value="" style="width:250px;height:30px;" required="required"/></td></tr>';
