      ...
      <table id="emp_table" border="0" class="resultGridTable" style="width: auto;margin-top: 1%;font-size:10px;">
        <tr class="tr_header" style="background-color:#3385ff;font-family:Tahoma, Geneva, sans-serif;font-size: 12px;">
          ...
          *
          ...
          ( ( (  IFNULL(ANY_VALUE(SUM(Qty)), 0)  - 
                 IFNULL(ddQty,  IFNULL(LastWIP, 0) ))  ) + 
                 IFNULL(returnrrQty, 0)  ) AS  balancecQty,
          ...
          FROM 
          product PoMst
         LEFT JOIN brandname ON PoMst.BrandName = brandname.id 
         LEFT JOIN commodity ON PoMst.Commodity = commodity.id   
