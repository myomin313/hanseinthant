...
fputcsv($output,  array('Branch','BrandName','Commodity','Input','WIP','Delivery','Return','Remark','Total Stock','Current Stock','TotalUSD','NetUSD','Balance USD'));  
}
else{
...
if(isset($_SESSION["InStock_namelist"])){
 ...
 $Branches = $_SESSION['Branch'];     
         ...
         IFNULL(returnrQty,0) AS rQty,
          ( ( (  IFNULL(ANY_VALUE(SUM(Qty)), 0) - IFNULL(LastWIP, 0) ) - IFNULL(ddQty, 0) ) + IFNULL(returnrrQty, 0)  ) AS  balancecQty,
