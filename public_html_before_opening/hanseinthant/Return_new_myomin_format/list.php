...
<!-- develop by Winsan -->
    <div class="row">
      <div class="col-sm-12">
        ...
        <input type="text" id="keywords" name="keyword" style="margin-left: 7px;width: 15%;" onKeyUp="searching()" placeholder="search..." /><span id="searching-box"></span>
...
*/
                ...
                *
                ...
                commodity.commodity as rcommodity
                  ...
                  ON returns.Customer= customer.UserId
                  JOIN brandname
                ON returns.BrandName= brandname.id JOIN commodity
                ON returns.Commodity= commodity.id
                  WHERE 1=1 ";
...
// develop by Winsan
                  if (isset($_POST['keyword'])) {
                    ...
                    $sqlA =$sqlA." AND (returns.BrandName LIKE '%$keyword%' OR customer.CustomerName LIKE '%$keyword%' OR returns.Customer LIKE '%$keyword%'OR returns.DO_No LIKE '%$keyword%' OR returns.department LIKE '%$keyword%' OR returns.Return_no LIKE '%$keyword%')";
                  }  
                  if ($_GET['namelist'] <> ''){
                    $sqlA =$sqlA." AND (returns.BrandName= '".$_GET['namelist']."' OR returns.Commodity= '".$_GET['namelist']."' OR returns.DO_No= '".$_GET['namelist']."' OR customer.CustomerName= '".$_GET['namelist']."' OR returns.department= '".$_GET['namelist']."' OR returns.Return_no= '".$_GET['namelist']."')";
                  }
