...
$sWhere = "";
$sqls=" SELECT returns.id,returns.Return_date,returns.Return_no,returns.department,customer.CustomerName,returns.Do_No,returns.BrandName,returns.Commodity,returns.Qty,returns.Type,returns.Remarks_item,returns.Creator,returns.CreateTime FROM returns 
                  LEFT JOIN customer
                ...
                $sWhere =$sWhere . " AND (returns.BrandName= '".$keyword."'OR customer.CustomerName= '".$keyword."'OR returns.Customer= '".$keyword."'OR returns.DO_No= '".$keyword."'OR returns.department= '".$keyword."')";
                }
