...
function addRow(frm) {
  ...
  row =  row +'<input type="text" name="NBrandName[]"  id="NBrandName'+rowNum+'" style="width:20%;height:30px;" required="required" autocomplete="off" onKeyUp="brand(\''+rowNum+'\')" placeholder="Brand"/><span id="suggesstion-box'+rowNum+'"></span>';
  var rows = '';
  <?php
 ...
 <body style="font-size: 11px; font-family:Tahoma, Geneva, sans-serif;">
      ...
      // echo $sql_item;
        ...
        while($row = mysqli_fetch_array($result)) {
          ...
          print '<tr><td>DO.No </td><td> <input type="text" name="DO_No" id="DO_No" value="' . $row['DO_No']. '" style="width:20%;height:30px;font-size:10px;"/></td></tr>';
    ...
    $('.deleteitemall').on('click',function(){
      var deliveryid = [];
       ...
       var LUser= document.getElementById('LUser').value;
          ...
          window.location.href = "removeall.php?ids="+deliveryid+"&LUser="+LUser+"&okyaku="+okyaku+"&Location="+Location+"&DO_No="+DO_No+"&JOB_No="+JOB_No+"";
