...
<?php $Branches = $_SESSION['Branch'];
        ...
        //   echo urldecode($_GET['namelist']);
          ...
          if ($_GET['day'] <> ''){
           ...
           $sqls = $sqls. "Order by product.Purchase_order_No";
    ...
    while($row = mysqli_fetch_array($result)){
              ...
              $message="Edit";
              print '<td  class="actions"><a href="detail.php?SupplierID=' . $row['SupplierID'] . '&PL=' . $row['Purchase_order_No'] . '" style="text-decoration: none;
              padding: 2px 5px;
              background: #2E8B57;
              color: white;
