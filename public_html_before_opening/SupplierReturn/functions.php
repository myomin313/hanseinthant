...
fputcsv($output,  array('id','Return date','Branch','Supplier','PL','Code','BrandName','Commodity','Qty','Type','Remark item','Creator','CreateTime'));  
// fetch the data
...
$sql = "SELECT supplier_return.id,supplier_return.Return_date,branch.branch,supplier.SupplierName,supplier_return.PL,code.code,brandname.brandname as BrandName,commodity.commodity as Commodity,supplier_return.Qty,supplier_return.type,supplier_return.Remark_item,supplier_return.Creator,supplier_return.CreateTime FROM supplier_return
  ...
  //   }
    ...
    if(isset($_POST['supplier'])  && $_POST['supplier'] != ''){
      ...
      $sWhere =$sWhere." AND supplier_return.supplier='$supplier'";
    }
    if(isset($_POST['Branch'])  && $_POST['Branch'] != ''){
      $Branch=$_POST['Branch'];
      $sWhere =$sWhere." AND supplier_return.Branch='$Branch'";
    }
    if(isset($_POST['BrandName']) && $_POST['BrandName'] != ''){
     $BrandName=$_POST['BrandName'];
     $sWhere =$sWhere." AND supplier_return.BrandName='$BrandName'";
   }
   if(isset($_POST['Commodity']) && $_POST['Commodity'] != ''){
     $Commodity=$_POST['Commodity'];
     $sWhere =$sWhere." AND supplier_return.Commodity='$Commodity'";
   }
   if(isset($_POST['code'])  && $_POST['code'] != ''){
     $code=$_POST['code'];
     $sWhere =$sWhere." AND supplier_return.code='$code'";
   }
   if(isset($_POST['PL']) && $_POST['PL'] != ''){
     $PL=$_POST['PL'];
     $sWhere =$sWhere." AND supplier_return.PL='$PL'";
   }
