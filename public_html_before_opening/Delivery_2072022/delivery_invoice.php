	...
	<div class="invoice-wrap" id="content">
		...
		<?php 
	        ...
	        if ($count_header > 0) {
	            ...
	            print'<div width="100%">';
	            print'<div width="50%" style="float:left">';
	            print'<span style="">To</sapn><br>'; 	
		        print'<span style="">Customer:' . $customer_name . '</span>';
	            print'</div>';
	            print'<div width="50%" style="float:right;margin-left:5%">';
	            print'<span style="">Date : '.$delivery_date.'</span><br>'; 		
				print '<span style="">Do.No : '.$Do_no.'</span><br>'; 
				print '<span style="">JOB.No : '.$Job_no.'</span>';	
	            print'</div>';  
	            print'</div>';  
		...
		<?php
		    ...
		    $sql="SELECT delivery.*,brandname.brandname as brandname,commodity.commodity as commodity
            FROM delivery 
