...
// <span  class="warn warning"></span><span style="color:#ff8566;">This Update is not for Commodity.</span></td></tr>'; 
  ...
  <script type="text/javascript">
        function Delete(id)
    {
       ...
       window.location.href = "remove.php?id="+id+"&LUser="+LUser+"&okyaku="+okyaku+"&Location="+Location+"&Delivery_date="+Delivery_date+"&DO_No="+DO_No+"&dep_name="+dep_name+"&JOB_No="+JOB_No+"&BrandName="+BrandName+"&Commodity="+Commodity+"&code="+code+"&Type="+Type+"&Qty="+Qty+"&PL="+PL+"&Remark_item="+Remark_item+""; 
