...
// $sql = "SELECT id,Delivery_date,DO_No,Location,Customer,BrandName,Commodity,Qty,Type,Remark_item,PL,Creator,CreateTime from delivery ";
   $sWhere = "";
   $sql=" SELECT delivery.id,delivery.Delivery_date,delivery.DO_No,delivery.Location,customer.customerName,brandname.brandname as BrandName,commodity.commodity as Commodity,delivery.Qty,delivery.Type,delivery.Remark_item,delivery.PL,delivery.Creator,delivery.CreateTime 
          FROM delivery 
