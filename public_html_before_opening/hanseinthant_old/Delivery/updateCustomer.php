         ...
         foreach($_POST['Commodity'] as $row =>$Commodity) { 
           ...
           // 11.13.2019 myo min start
             $sqls = "SELECT * FROM job where Customer= '$oldCustomer' and Location= '$oldBranch' and BrandName = '$BrandName' and Commodity = '$Commoditys'";              
                 ...
                 VALUES ('$Oid','$okyaku','$OCustomer','$OBrandName','$OBrandName','$OCommodity','$OCommodity','$ORemarks_Item','$ORemarks_Item','$OJob_date','$OJob_date','$OJob_No','$OJob_No','$OProject','$OProject','$OWIP','$OWIP','$OType','$OType','$Location','$oldBranch','$OPL','$OPL','$RecordTime','$LUser','$status')";
                ...
                VALUES ('$Oid','$okyaku','$OCustomer','$OBrandName','$OBrandName','$OCommodity','$OCommodity','$ORemark_Item','$ORemark_Item','$ODelivery_date','$ODelivery_date','$DO_No','$ODO_No','$OJOB_No','$OJOB_No','$OQty','$OQty','$OPL','$OPL','$OType','$OType','$Location','$OLocation','$RecordTime','$LUser','$status')";
           ...
           // 11.13.2019 myo min end           
            $sqld = " UPDATE job SET Customer ='$okyaku',Location ='$Location' WHERE Customer = '$oldCustomer' and Location = '$oldBranch' and BrandName = '$BrandName' and Commodity = '$Commoditys'";
             mysqli_query($con ,$sqld);

           $sqlr = " UPDATE returns SET Customer ='$okyaku',department ='$Location',DO_No='$DO_No' WHERE Customer = '$oldCustomer' and department = '$oldBranch' and BrandName = '$BrandName' and Commodity = '$Commoditys'";
