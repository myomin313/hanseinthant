 ...
 <body style="font-size: 11px; font-family:Tahoma, Geneva, sans-serif;">
      ...
      // echo $sql_item;
        ...
        while($row = mysqli_fetch_array($result)) {
          ...
          print '<tr><td>DO.No </td><td> <input type="text" name="DO_No" id="DO_No" value="' .$matches[1]. '" style="width:10%;height:30px;font-size:10px;"/>';
...
// <span  class="warn warning"></span><span style="color:#ff8566;">This Update is not for Commodity.</span></td></tr>'; 
  ...
  <script type="text/javascript">
        function update(id)
    {
       ...
       window.location.href = "update.php?id="+id+"&LUser="+LUser+"&okyaku="+okyaku+"&Location="+Location+"&Delivery_date="+Delivery_date+"&DO_No="+DO_No+"&dep_name="+dep_name+"&JOB_No="+JOB_No+"&BrandName="+BrandName+"&Commodity="+Commodity+"&Type="+Type+"&Qty="+Qty+"&PL="+PL+"&Remark_item="+Remark_item+""; 
  ...
  <script type="text/javascript">
        function Delete(id)
    {
       ...
       window.location.href = "remove.php?id="+id+"&LUser="+LUser+"&okyaku="+okyaku+"&Location="+Location+"&Delivery_date="+Delivery_date+"&DO_No="+DO_No+"&dep_name="+dep_name+"&JOB_No="+JOB_No+"&BrandName="+BrandName+"&Commodity="+Commodity+"&Type="+Type+"&Qty="+Qty+"&PL="+PL+"&Remark_item="+Remark_item+""; 
