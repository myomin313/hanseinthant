     ...
     // $Job_date=$_GET['Job_date']; 
      ...
      //             $OLocation ="";
       ...
       foreach($idarray as $id) {                                   
                  ...
                  $OPL = $row['PL']; 
        $sql = "SELECT JOB_No,Commodity,BrandName,PL,Location,Customer  FROM delivery WHERE JOB_No ='$Job_No' and Commodity ='$OCommodity' and BrandName ='$OBrandName' and PL ='$OPL' and Location ='$Location' and Customer ='$okyaku'";
        // echo $sql;
      ...
      if($count==1)
                ...
                VALUES ('$id','','$OCustomer','','$OBrandName','','$OCommodity','','$ORemarks_Item','','$OJob_date','','$OJob_No','','$OProject','','$OWIP','','$OType','','$OLocation','','$OPL','$RecordTime','$Recorder','$status')";      
                  ...
                  $sql="SELECT * FROM product Where BrandName = '$OBrandName' and Commodity ='$OCommodity' and Branch ='$Location' and Purchase_order_No ='$OPL'";
                  $result=mysqli_query($con ,$sql); 
                 ...
                 $job = $resultjob->fetch_assoc();                    
                  ...
                  $sql = " UPDATE product SET balanceWIP ='$balanceWIP' Where BrandName = '$OBrandName' and Commodity ='$OCommodity' and Branch ='$Location' and Purchase_order_No ='$OPL'"; 
                  mysqli_query($con ,$sql);

                  $sqlproduct="SELECT * FROM product Where BrandName = '$OBrandName' and Commodity ='$OCommodity' and Branch ='$Location' and Purchase_order_No ='$OPL'";
                  ...
                  $sql = " UPDATE product SET balanceQty ='$balances' Where BrandName = '$OBrandName' and Commodity ='$OCommodity' and Branch ='$Location' and Purchase_order_No ='$OPL'"; 
                  mysqli_query($con ,$sql);
