...
$query ="SELECT DISTINCT brandname.brandname as BrandName,Location FROM job LEFT JOIN brandname ON job.BrandName= brandname.id WHERE brandname.brandname like '" . $keyword  . "%' and Location='Shwe Pyi Thar Store'  ORDER BY brandname.brandname LIMIT 0,15";
// echo $query;
...
<li onClick="set_items('<?php echo addcslashes(htmlspecialchars($brands, ENT_QUOTES), "'"); ?>');"><?php echo $row["BrandName"]; ?></li>
<?php } ?>
</ul>
<?php } 


$query ="SELECT commodity.commodity as Commodity,Location FROM job LEFT JOIN commodity
                  ON job.Commodity= commodity.id WHERE commodity.commodity like '" . $keyword  . "%'  and Location='Shwe Pyi Thar Store' ORDER BY commodity.commodity LIMIT 0,15";
// echo $query;
$result =  $con->query($query);
if(!empty($result)) {
?>
...
$keyword = mysqli_real_escape_string($con,$_POST['keyword']);
$query ="SELECT DISTINCT brandname.brandname as BrandName,Location FROM job LEFT JOIN brandname ON job.BrandName= brandname.id WHERE brandname.brandname like '" . $keyword  . "%' and Location='Shwe Pyi Thar Store Control Panel' ORDER BY brandname.brandname LIMIT 0,15";
// echo $query;
$result =  $con->query($query);
if(!empty($result)) {
?>
...
$query ="SELECT DISTINCT commodity.commodity as Commodity,Location FROM job LEFT JOIN commodity ON job.Commodity= commodity.id WHERE commodity.commodity like '" . $keyword  . "%'  and Location='Shwe Pyi Thar Store Control Panel' ORDER BY commodity.commodity LIMIT 0,15";
// echo $query;
$result =  $con->query($query);
if(!empty($result)) {
?>
...
$keyword = mysqli_real_escape_string($con,$_POST['keyword']);
$query ="SELECT DISTINCT brandname.brandname as BrandName,Location FROM job LEFT JOIN brandname ON job.BrandName= brandname.id WHERE brandname.brandname like '" . $keyword  . "%' and Location='Yangon Show Room' ORDER BY brandname.brandname LIMIT 0,15";
// echo $query;
$result =  $con->query($query);
if(!empty($result)) {
?>
...
$query ="SELECT DISTINCT commodity.commodity as Commodity,Location FROM job LEFT JOIN commodity
                  ON job.Commodity= commodity.id WHERE commodity.commodity like '" . $keyword  . "%'  and Location='Yangon Show Room' ORDER BY commodity.commodity LIMIT 0,15";
// echo $query;
$result =  $con->query($query);
if(!empty($result)) {
?>
...
$keyword = mysqli_real_escape_string($con,$_POST['keyword']);
$query ="SELECT DISTINCT brandname.brandname as BrandName,Location FROM job LEFT JOIN brandname
                  ON job.BrandName= brandname.id WHERE brandname.brandname like '" . $keyword  . "%' and Location='Mandalay Show Room' ORDER BY brandname.brandname LIMIT 0,15";
// echo $query;
$result =  $con->query($query);
if(!empty($result)) {
?>
...
$query ="SELECT DISTINCT commodity.commodity as Commodity,Location FROM job LEFT JOIN commodity
                  ON job.Commodity= commodity.id WHERE commodity.commodity like '" . $keyword  . "%'  and Location='Mandalay Show Room' ORDER BY commodity.commodity LIMIT 0,15";
// echo $query;
$result =  $con->query($query);
if(!empty($result)) {
?>
...
$keyword = mysqli_real_escape_string($con,$_POST['keyword']);
$query ="SELECT DISTINCT brandname.brandname as BrandName,Location FROM job LEFT JOIN brandname ON job.BrandName= brandname.id WHERE brandname.brandname like '" . $keyword  . "%' and Location='Naypyidaw Show Room'  ORDER BY brandname.brandname LIMIT 0,15";
// echo $query;
$result =  $con->query($query);
if(!empty($result)) {
?>
...
$query ="SELECT commodity.commodity as Commodity,Location FROM job LEFT JOIN commodity
                  ON job.Commodity= commodity.id WHERE commodity.commodity like '" . $keyword  . "%'  and Location='Naypyidaw Show Room' ORDER BY commodity.commodity LIMIT 0,15";
// echo $query;
$result =  $con->query($query);
if(!empty($result)) {
?>
...
$keyword = mysqli_real_escape_string($con,$_POST['keyword']);
$query ="SELECT brandname.brandname as BrandName FROM job LEFT JOIN brandname ON job.BrandName= brandname.id WHERE brandname.brandname like '" . $keyword  . "%'";
// echo $query;
$result =  $con->query($query);
if(!empty($result)) {
?>
...
$query ="SELECT commodity.commodity as Commodity,Location FROM job LEFT JOIN commodity
                  ON job.Commodity= commodity.id WHERE commodity.commodity like '" . $keyword  . "%'  ORDER BY commodity.commodity LIMIT 0,15";
// echo $query;
$result =  $con->query($query);
if(!empty($result)) {
?>
