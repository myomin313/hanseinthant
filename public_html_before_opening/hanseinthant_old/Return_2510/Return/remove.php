...
$q2 = $con->query($setutf7);
      ...
      $PL=$_GET['PL']; 
                ...
                $sqldelivery="SELECT returnQty FROM delivery Where BrandName = '$BrandName' and Commodity ='$Commodity' and Location ='$department' and PL ='$PL'";
                ...
                $returnQty = $delivery['returnQty'] - $_GET['quan'];
                 ...
                 // echo $sql;
                 mysqli_query($con ,$sql); 
                 $sql="DELETE FROM returns WHERE id='$id' AND Customer='$okyaku'and PL='$PL'";
		             // echo $sql;
                 mysqli_query($con ,$sql);
