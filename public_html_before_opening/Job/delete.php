<?php 
    ...
    $q2 = $con->query($setutf7);*/
      ...
      $WIP=$_GET['WIP']; 
        ...
        $sql = "SELECT JOB_No,Commodity,BrandName,code,PL,Location,Customer  FROM delivery WHERE JOB_No ='$Job_No' and Commodity ='$Commodity' and code='$code' and BrandName ='$BrandName' and PL ='$PL' and Location ='$Location' and Customer ='$okyaku'";
        // echo $sql;
      ...
      if($count==1)
                ...
                VALUES ('$id','','$OCustomer','$OBrandName','$OCommodity','$Ocode','','$ORemarks_Item','','$OJob_date','','$OJob_No','','$OProject','','$OWIP','','$OType','','$OLocation','','$OPL','$RecordTime','$Recorder','$status')";      
                  ...
                  $sql="SELECT * FROM product Where BrandName = '$BrandName' and Commodity ='$Commodity' and code ='$code' and Branch ='$Location' and Purchase_order_No ='$PL'";
                  $result=mysqli_query($con ,$sql); 
                ...
                //  $sqljob="SELECT * FROM job Where BrandName = '$BrandName' and Commodity ='$Commodity' and Location ='$Location' and PL ='$PL' and Job_No ='$Job_No'";
                 ...
                 $job = $resultjob->fetch_assoc();                    
                  ...
                  $sql = " UPDATE product SET balanceWIP ='$balanceWIP' Where BrandName = '$BrandName' and Commodity ='$Commodity' and code ='$code' and Branch ='$Location' and Purchase_order_No ='$PL'"; 
                  mysqli_query($con ,$sql);

                  $sqlproduct="SELECT * FROM product Where BrandName = '$BrandName' and Commodity ='$Commodity' and code ='$code' and Branch ='$Location' and Purchase_order_No ='$PL'";
                  ...
                  $sql = " UPDATE product SET balanceQty ='$balances' Where BrandName = '$BrandName' and Commodity ='$Commodity' and code ='$code' and Branch ='$Location' and Purchase_order_No ='$PL'"; 
                  mysqli_query($con ,$sql);
