...
<?php }
 ...
 //  start myo
$query ="SELECT DISTINCT Return_no,department FROM returns WHERE Return_no like '" . $keyword  . "%' and department='Shwe Pyi Thar Store' ORDER BY DO_No ";
// echo $query;
$result =  $con->query($query);
if(!empty($result)) {
?>
...
<li onClick="set_items('<?php echo $row["Return_no"]; ?>');"><?php echo $row["Return_no"]; ?></li>
<?php } ?>
</ul>
<?php }
// end myo 
...
<?php }
 //  start myo
$query ="SELECT DISTINCT Return_no,department FROM returns WHERE Return_no like '" . $keyword  . "%' and department='Shwe Pyi Thar Store Control Panel' ORDER BY DO_No ";
// echo $query;
$result =  $con->query($query);
if(!empty($result)) {
?>
...
<?php } 
 ...
 //  start myo
$query ="SELECT DISTINCT Return_no,department FROM returns WHERE Return_no like '" . $keyword  . "%' and department='Yangon Show Room' ORDER BY DO_No ";
// echo $query;
$result =  $con->query($query);
if(!empty($result)) {
?>
...
<?php } 
  ...
  //  start myo
$query ="SELECT DISTINCT Return_no,department FROM returns WHERE Return_no like '" . $keyword  . "%' and department='Naypyidaw Show Room' ORDER BY DO_No ";
// echo $query;
$result =  $con->query($query);
if(!empty($result)) {
?>
...
<?php } 
  //  start myo
$query ="SELECT DISTINCT Return_no,department FROM returns WHERE Return_no like '" . $keyword  . "%' and department='Mandalay Show Room' ORDER BY DO_No ";
// echo $query;
$result =  $con->query($query);
if(!empty($result)) {
?>
...
<?php } 
 //  start myo
$query ="SELECT DISTINCT Return_no FROM returns WHERE Return_no like '" . $keyword  . "%'  ORDER BY DO_No ";
// echo $query;
$result =  $con->query($query);
if(!empty($result)) {
?>
