...
//if (isset($_POST['Update'])) {
            ...
            foreach($_POST['Commodity'] as $row=>$Commodity) {    
                  ...
                  $sql="INSERT INTO product_history(input_ID,SupplierName,OSupplierName,BrandName,OBrandName,Commodity,OCommodity,code,Ocode,Branch,OBranch,Remarks_Item,ORemarks_Item,Packing_date,OPacking_date,Purchase_order_No,OPurchase_order_No,PO_NO,OPO_NO,Qty,OQty,totalRate,OtotalRate,Rate_Name,ORate_Name,Type,OType,RecordTime,Recorder,status) 
                  VALUES ('$id','$SupplierName','$OSupplierName','$BrandName','$OBrandName','$Commodity','$OCommodity','$code','$Ocode','$Branch','$OBranch','$Remarks_Item','$ORemarks_Item','$Packing_date','$OPacking_date','$Purchase_order_No','$OPurchase_order_No','$PO_NO','$OPO_NO','$Qty','$OQty','$totalRate','$OtotalRate','$Rate_Name','$ORate_Name','$Type','$OType','$RecordTime','$Recorder','$status')";
                  ...
                  $sqlupdateproduct="UPDATE product SET SupplierName='$SupplierName', BrandName='$BrandName',Commodity='$Commodity',code='$code',Branch='$Branch', Remarks_Item='$Remarks_Item',  Packing_date='$Packing_date',Purchase_order_No='$Purchase_order_No',  PO_NO='$PO_NO',Qty='$Qty',balanceQty='$Qty', rate='$rate', totalRate='$totalRate',Type='$Type',Rate_Name='$Rate_Name' WHERE  id = '$id'";
                   ...
                   $updatesupplier = " UPDATE supplier_return SET Supplier='$SupplierName' WHERE PL = '$OPurchase_order_No' and Branch = '$OBranch' and BrandName = '$OBrandName' and Commodity = '$OCommodity' and code='$Ocode'";
                ...
                echo "<script type='text/javascript'>window.top.location='detail.php?SupplierID=$SupplierName&Branch=$Branch&Packing_date=$Packing_date&PL=$Purchase_order_No';</script>";exit;
