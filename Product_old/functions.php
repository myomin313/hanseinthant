...
include_once('../config.php');
 if(isset($_POST["Import"])){
  ...
  fputcsv($output,  array('id','Date','SupplierName','Branch','BrandName','Commodity','Type','Stock In','Wip','Delivery','Return','Balance','Current Qty','Remarks','Name','TotalUSD','DeliveryUSD','PL NO','PO NO','Creator','CreateTime'));  
//   $setutf8 = "SET NAMES utf8";
//   $q = $con->query($setutf8);
//   $setutf8c = "SET character_set_results = 'utf8', character_set_client =
//   'utf8', character_set_conection = 'utf8', character_set_database = 'utf8',
...
// 12.12.2019 myo min start
              ...
              if(!empty($_POST['searchkeyword'])){
                ...
                $sWhere =$sWhere . " AND (supplier.SupplierName= '".$keyword."'OR product.BrandName= '".$keyword."'OR product.branch= '".$keyword."'OR product.Purchase_order_No= '".$keyword."'OR product.PO_NO= '".$keyword."'OR product.Commodity= '".$keyword."')";
                }
