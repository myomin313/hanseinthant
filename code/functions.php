...
if(isset($_POST["Export"])){
 ...
 $filename = "Code No list/" . date('Y-m-d') . ".csv";
...
// output headers so that the file is downloaded rather than displayed
 ...
 fputcsv($output,  array('id','Code No','BrandName','Commodity'));
...
// $sql = "SELECT id,Delivery_date,DO_No,Location,Customer,BrandName,Commodity,Qty,Type,Remark_item,PL,Creator,CreateTime from delivery ";
   $sWhere = "";
   $sql=" SELECT code.id,code.code,brandname.brandname,commodity.commodity
          FROM code
          JOIN brandname ON code.brandname= brandname.id 
          JOIN commodity ON code.commodity= commodity.id"; 
