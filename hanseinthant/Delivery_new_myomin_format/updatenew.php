<?php
 ...
 if($count==1)
      ...
      $sqlW="SELECT currentQty,USD FROM product Where BrandName = '$NBrandName' and Commodity ='$NCommodity' and Branch ='$Location' and Purchase_order_No ='$txtHintss'";
...
$sql="INSERT INTO delivery (Location,Customer,Commodity,BrandName,Type,PL,Qty,Delivery_date,DO_No,JOB_No,Remark_item,returnQty,Creator,CreateTime,deliveryUSD) VALUES ('$Location','$okyaku','$NCommodity','$NBrandName','$NType','$txtHintss','$NQty','$Delivery_date','$DO_No','$JOB_No','$NRemark','$returnQty','$LUser','$CreateTime','$deliveryUSD')";
