...
#Commodity{padding: 10px;border: #a8d4b1 1px solid;border-radius:4px;}
 ...
 <body style="font-size: 11px; font-family:Tahoma, Geneva, sans-serif;">
      ...
      // echo $sql_item;
        ...
        $i=0;
        while($row = mysqli_fetch_array($result)) {
          print '<input  type="text" name="BrandName[]" id="BrandName'. $row["id"].'" value="' . $row["BrandName"].'" style="width:20%;height:30px;background-color:#f2f2f2;margin-left:0px;font-size:10px;" readonly/>';
          print '&nbsp&nbsp<input  type="text" name="Commodity[]" id="Commodity'. $row["id"].'" value="' . $row["Commodity"].'" style="width:15%;height:30px;background-color:#f2f2f2;margin-left:0px;font-size:10px;" readonly/>';
          print'&nbsp&nbsp<input type="text" name="Types[]" id="Type'. $row["id"].'"  value="' . $row["Type"]. '"  style="width:4%;height:30px;margin-left:10px;background-color:#f2f2f2;font-size:10px;" readonly/>';
          print '&nbsp&nbsp<input type="text" name="Qty[]" id="Qty'. $row["id"].'" value="' .$row["Qty"]. '" style="width:5%;height:30px;background:#f2f2f2;font-size:10px;" onkeyup="cal('. $row["id"].')" readonly/>';     
          print '&nbsp<input type="text" name="PL[]" id="PL'. $row["id"].'" value="'. $row["PL"].'" style="width:10%;height:30px;background:#f2f2f2;font-size:10px;" readonly/>';           
          print '&nbsp&nbsp<input  type="text" name="Remark_item[]" id="Remark_item'. $row["id"].'" value="' . $row["Remark_item"]. '" style="width:28%;height:30px;font-size:10px;" placeholder="Remark"/>';
