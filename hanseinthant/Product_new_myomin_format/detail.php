      ...
      success:function(data)
      {
        ...
        for(var count = 0; count < data.length; count++)
        {
          ...
          $("#itemCommodity"+x+"").html(html);              
            ...
            $(news).append('<div><br><select name="itemBrandName[]" id="itemBrandName'+x+'" style="width:20%;height:30px;"  required="required" onblur="fncClearBox(this,'+x+',\'brand\')" onKeyUp="brand('+x+')" placeholder="Brand"/></select>              &nbsp&nbsp<select name="itemCommodity[]" id="itemCommodity'+x+'" style="width:15%;height:30px;"  required="required" onblur="fncClearBox(this,'+x+',\'brand\')" onKeyUp="brand('+x+')" placeholder="commodity"/></select>&nbsp<select name="itemType[]" id="itemType'+x+'"  style="width:4%;height:30px;border: #1aa3ff 1px solid;"><option value=""></option><option value="Set">Set</option><option value="No">No</option><option value="Lot">Lot</option><option value="ft">ft</option><option value="mtrs">mtrs</option><option value="Coils">Coils</option><option value="kg">kg</option><option value="Yard">Yard</option></select>&nbsp&nbsp<select name="Rate_Names[]" id="Rate_Names'+x+'"  style="width:7%;height:30px;border: #1aa3ff 1px solid;"><option value=""></option><option value="USD">USD</option><option value="Myanmar">Myanmar</option><option value="Singapore">Singapore</option><option value="Europe">Europe</option><option value="Thailand">Thailand</option><option value="British">British</option><option value="Japan">Japan</option><option value="Australia">Australia</option></select>&nbsp&nbsp<input type="text" name="itemrate[]" id="itemrate'+x+'" style="width:6%;height:30px;border: #1aa3ff 1px solid;" onkeyup="calculate('+x+')" placeholder="1 item/per Rate">&nbsp&nbsp<input type="number" name="itemQty[]" id="itemQty'+x+'" style="width:4%;height:30px;border: #1aa3ff 1px solid;font-size:10px;"  onkeyup="calculate('+x+')" placeholder="Qty"/>&nbsp&nbsp<input type="text" name="totalRates[]" id="totalRates'+x+'" style="width:6%;height:30px;border: #1aa3ff 1px solid;" onkeyup="calculate('+x+')">&nbsp&nbsp<input type="text" name="itemRemarks_Item[]" id="itemRemarks_Item'+x+'" style="width:25%;height:30px;border: #1aa3ff 1px solid;" />&nbsp<input type="button" value="Submit" class="updateitem" onclick="save('+x+')"><input type="button" value="remove"  onclick="removeRow('+x+');" class="removeitem"></div>'); 
          }
 ...
 <body style="font-size: 11px; font-family:Tahoma, Geneva, sans-serif;">
      ...
      <?php 
        ...
        /* $sql_item ="SELECT *,supplier.SupplierName as supplier,product.SupplierName as SupplierNameA,product.Creator as Creator,product.Branch as Branch,
            ...
            $sql_item = "SELECT 
            supplier.SupplierName as supplier,product.SupplierName as SupplierNameA,product.Branch as Branch,
     ...
     /*   $BrandName = explode(',', $BrandName);
        ...
        $sql_item = "SELECT 
         ...
         print'<option style="width:200px;height:30px;font-size: 10px;" value="'.$row['cid'].'">'. htmlspecialchars($row['Commodity'], ENT_COMPAT).'</option>';
          ...
          print '&nbsp&nbsp<input type="text" name="Qty[]" id="Qty'. $row['id'].'" value="'. htmlspecialchars($row['Qty'], ENT_COMPAT).'" style="width:4%;height:30px;font-size: 10px;" onkeyup="out('. $row['id'].')" />';                 
