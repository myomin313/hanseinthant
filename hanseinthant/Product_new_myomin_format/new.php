...
$("#commodity"+rowNum+"").select2( {
  ...
  var row = '<p id="rowNum'+rowNum+'">';
    ...
    row = row+'<select name="BrandName[]" id="brandname'+rowNum+'" style="width:20%;height:30px;"  required="required" onblur="fncClearBox(this,'+rowNum+',\'brand\')" onKeyUp="brand('+rowNum+')" placeholder="Brand"/></select>';

    row = row+'<select name="itemCommodity[]" id="commodity'+rowNum+'" style="width:15%;height:30px;"  required="required" onblur="fncClearBox(this,'+rowNum+',\'brand\')" onKeyUp="brand('+rowNum+')" placeholder="commodity"/></select>';
    ...
    row =  row +'<select name="itemType[]" id="Type'+rowNum+'" style="width:4%;height:30px;" required="required"><option value=""></option><option value="Set">Set</option><option value="No">No</option><option value="Lot">Lot</option><option value="ft">ft</option><option value="mtrs">mtrs</option><option value="Coils">Coils</option><option value="kg">kg</option><option value="Yard">Yard</option></select>&nbsp<select name="Rate_Name[]" id="Rate_Name"  style="width:5%;height:30px;"><option value=""></option><option value="USD">USD</option><option value="Myanmar">Myanmar</option><option value="Singapore">Singapore</option><option value="Europe">Europe</option><option value="Thailand">Thailand</option><option value="British">British</option><option value="Japan">Japan</option><option value="Australia">Australia</option></select>&nbsp<input type="text" name="rate[]" id="rate'+rowNum+'" style="width:8%;height:30px;" placeholder="1 per/rate" onkeyup="out('+rowNum+')">&nbsp<input type="number" name="itemQty[]" id="itemQty'+rowNum+'" style="width:5%;height:30px;" placeholder="Qty" onkeyup="out('+rowNum+')"/>&nbsp<input type="text" name="totalRate[]" id="totalRate'+rowNum+'" style="width:8%;height:30px;" placeholder="rate" onkeyup="out('+rowNum+')">&nbsp<input type="text" name="itemRemarks_Item[]" style="width:25%;height:30px;" placeholder="Remark"/>&nbsp&nbsp&nbsp<input type="button" value="remove"  onclick="removeRow('+rowNum+');" class="removeitem"></p>';
