<?php
      ...
      $PL=$_GET['PL']; 
             ...
             mysqli_query($con ,$sql);      
                  ...
                  $sql = " UPDATE delivery SET Customer ='$OCustomer',Location='$OLocation',Delivery_date='$ODelivery_date',DO_No ='$ODO_No',JOB_No ='$OJOB_No',BrandName ='$OBrandName',Commodity ='$OCommodity',Qty ='$OQty',Type ='$OType',Remark_item ='$Remark_item' WHERE id='$id' and Customer = '$okyaku' and Location = '$Location' and DO_No = '$DO_No' ";  
                //   echo $sql;
