...
$sWhere = "";
$sql = "SELECT job.id,job.Job_No,job.Job_date,job.Location,customer.CustomerName,brandname.brandname as BrandName,commodity.commodity as Commodity,job.WIP,job.Type,job.Remarks_Item,job.Project,job.Creator,job.CreateTime FROM job JOIN brandname ON job.BrandName= brandname.id JOIN commodity ON job.Commodity= commodity.id  LEFT JOIN customer
