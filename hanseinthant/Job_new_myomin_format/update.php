<?php
      ...
      $WIP=$_GET['WIP']; 
                  ...
                  $sqlq = " UPDATE job SET WIP ='$WIP' WHERE id='$id' and Location = '$Location' and Job_No = '$Job_No' and Customer = '$okyaku'
                    and BrandName = '$BrandName' and Commodity = '$Commodity'";
                     mysqli_query($con ,$sqlq);
                                   
                  $sql="SELECT * FROM job WHERE  id = '$id' and Location = '$Location' and Job_No = '$Job_No' and Customer = '$okyaku' and BrandName = '$BrandName' and Commodity = '$Commodity'";
              ...
              elseif ($row['WIP'] < $row['balanceWIP'] ) {
                ...
                VALUES ('$id','$okyaku','$OCustomer','$BrandName','$OBrandName','$Commodity','$OCommodity','$Remarks_Item','$ORemarks_Item','$Job_date','$OJob_date','$Job_No','$OJob_No','$Project','$OProject','$WIP','$OWIP','$Types','$OType','$Location','$OLocation','$PL','$OPL','$RecordTime','$Recorder','$status')";
                ...
                //   else{}
                  ...
                  $sqlS="SELECT SUM(balanceJOB) as inputWIP FROM job Where BrandName = '$BrandName' and Commodity ='$Commodity' and Location ='$Location' and PL ='$PL' ";
                  $resultS=mysqli_query($con ,$sqlS); 
                  $rows = $resultS->fetch_assoc();
                  $inputWIP = $rows['inputWIP']  ;

                    $sqlA = " UPDATE product SET  balanceWIP='$inputWIP' WHERE  Branch = '$Location' and Purchase_order_No = '$PL' and  BrandName = '$BrandName' and Commodity = '$Commodity'";    
                 mysqli_query($con ,$sqlA);
                
                  $sqlSA="SELECT balanceWIP,balanceDelivery,Qty,balanceQty,currentQty,balanceReturn FROM product Where BrandName = '$BrandName' and Commodity ='$Commodity' and Branch ='$Location' and Purchase_order_No ='$PL' ";
            ...
            $deliReturn= $rowsA['balanceDelivery'] - $rowsA['balanceReturn'];
                  ...
                  $sqlA = " UPDATE product SET  balanceQty='$inputBalance', currentQty='$currentBalance' WHERE  Branch = '$Location' and Purchase_order_No = '$PL' and  BrandName = '$BrandName' and Commodity = '$Commodity'";    
                 mysqli_query($con ,$sqlA);         
