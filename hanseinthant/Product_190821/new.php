  ...
  jQuery('#rowNum'+rnum).remove();
      ...
      var u = 0;
        ...
        function out(x) {
               ...
               document.getElementById('totalRate'+x).value =totalRate.toFixed(0);;
...
<div id="outer-container" >
    <div id="scrollable">
     <form method="POST" action="save.php">       
          ...
          <?php
            print '<table style="width: 100%;font-size: 11px; font-family:Tahoma, Geneva, sans-serif;" id="customers" >';
         ...
         if ($Branches == "Shwe Pyi Thar Store") {
          ...
          elseif ($Branches == "Naypyidaw Show Room") {
              print '<tr><td style="width:8%;">Branch</td><td>
                          ...
                          title="Enter a date in this format YYYY-MM-DD" style="width:20%;height:30px;font-size: 11px;" required="required" onKeyUp="checkdates()" required="required"/><span style="color:orange;font-weight:bold;">&nbsp*&nbsp&nbspPlease make sure your Date.Your date must be inserted in Daily Rate. </span>
                          </td></tr>'; 
