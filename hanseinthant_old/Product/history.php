          ...
          <table style="margin-top: 20px;margin-bottom: 20px;border-collapse: collapse;width: auto;" id="emp_table" border="0" >
              <tr class="tr_header" style="background-color:#3385ff;font-family:Tahoma, Geneva, sans-serif;font-size: 13px;">
                <?php 
                  ...
                  ob.brandname as obrandname,oc.commodity as ocommodity
                   FROM product_history
                   JOIN brandname b ON product_history.BrandName= b.id 
                   JOIN commodity c ON product_history.Commodity= c.id
                   JOIN brandname ob ON product_history.OBrandName= ob.id 
                   JOIN commodity oc ON product_history.OCommodity= oc.id
                    WHERE 1=1 ";
                  if ($rowCount > 0) {
                  ...
                  if ($count > 0){                 
                    ...
                    elseif ($row['SupplierName'] != "" && $row['status'] == "New") {
                      ...
                      else
                      {
                        ...
                        if ($row['SupplierName'] != "" && $row['status'] == "Delete") {
