          ...
          <table style="margin-top: 20px;margin-bottom: 20px;border-collapse: collapse;width: auto;font-size: 11px;" id="emp_table" border="0" >
              <tr class="tr_header" style="background-color:#3385ff;font-family:Tahoma, Geneva, sans-serif;font-size: 13px;">
                ...
                // echo $_POST['users'];
                  ...
                  $sqls="SELECT *,Supplier,OSupplier,b.brandname as brandname,c.commodity as commodity,ob.brandname as obrandname,oc.commodity as ocommodity
                   FROM supplierreturn_history
                   LEFT JOIN brandname b  ON supplierreturn_history.BrandName= b.id 
                   LEFT JOIN commodity c  ON supplierreturn_history.Commodity= c.id
                   LEFT JOIN brandname ob ON supplierreturn_history.OBrandName= ob.id 
                   LEFT JOIN commodity oc ON supplierreturn_history.OCommodity= oc.id 
                    WHERE 1=1 ";
