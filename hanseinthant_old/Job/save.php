...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
      ...
      $row_data[] = "('$Location','$okyaku','$Commoditys','$BrandName','$WIP','$WIP','$Type','$Job_date','$Project','$Job_No','$PL','$Remarks_Item','$balanceWIP','$CreateTime','$LUser')";
...
//2019-08-07 newton USD column is not include       $sqlresult="SELECT Qty,balanceWIP,balanceDelivery,balanceReturn FROM product Where BrandName = '$BrandName' and Commodity ='$Commoditys' and Branch ='$Location' and Purchase_order_No ='$PL'";
        $sqlresult="SELECT Qty,balanceWIP,balanceDelivery,balanceReturn,USD FROM product Where BrandName = '$BrandName' and Commodity ='$Commoditys' and Branch ='$Location' and Purchase_order_No ='$PL'";
      ...
      $s = " UPDATE product SET balanceQty ='$balanceQtyss' Where BrandName = '$BrandName' and Commodity ='$Commoditys' and Branch ='$Location' and Purchase_order_No ='$PL'"; 
...
//2019-08-07 newton ☆☆☆$_GET['PL']☆☆☆ is not exist $sql = " UPDATE product SET  balanceUSD='$balanceUSDs' Where BrandName = '$BrandName' and Commodity ='$Commoditys' and Branch ='$Location'  and Purchase_order_No ='".$_GET['PL']."'"; 
      $sql = " UPDATE product SET  balanceUSD='$balanceUSDs' Where BrandName = '$BrandName' and Commodity ='$Commoditys' and Branch ='$Location'  and Purchase_order_No ='".$PL."'"; 
      ...
      $sql = 'INSERT INTO job(Location,Customer,Commodity,BrandName,WIP,balanceJOB,Type,Job_date,Project,Job_No,PL,Remarks_Item,balanceWIP,CreateTime,Creator) VALUES '.implode
      (',', $row_data);
