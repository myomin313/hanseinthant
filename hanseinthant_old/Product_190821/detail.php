...
<?php endif ?>
     ...
     function save(x)
    {
       ...
       window.location.href = "updatenew.php?SupplierName="+SupplierName+"&itemBrandName="+itemBrandName+"&Branch="+Branch+"&Packing_date="+Packing_date+"&Purchase_order_No="+Purchase_order_No+"&PO_NO="+PO_NO+"&itemBrandName="+itemBrandName+"&itemCommodity="+itemCommodity+"&itemType="+itemType+"&Rate_Names="+Rate_Names+"&itemrate="+itemrate+"&itemQty="+itemQty+"&totalRates="+totalRates+"&itemRemarks_Item="+itemRemarks_Item+"&LUser="+LUser+""; 
         // alert(Region);
 ...
 <body style="font-size: 11px; font-family:Tahoma, Geneva, sans-serif;">
  ...
  <script type="text/javascript">
        function update(id)
    {
       ...
       window.location.href = "update.php?id="+id+"&LUser="+LUser+"&SupplierName="+SupplierName+"&Branch="+Branch+"&Packing_date="+Packing_date+"&Purchase_order_No="+Purchase_order_No+"&PO_NO="+PO_NO+"&BrandName="+BrandName+"&Commodity="+Commodity+"&Type="+Type+"&Rate_Name="+Rate_Name+"&rate="+rate+"&Qty="+Qty+"&totalRate="+totalRate+"&Remarks_Item="+Remarks_Item+""; 
         // alert(Region);
