<?php
   ...
   $sqlA = "SELECT DISTINCT BrandName,Commodity,PL FROM transfer WHERE BrandName ='$NBrandName' and Commodity= '$NCommodity' and code='$code' and PL = '$txtHintss' and transfer_from= '$transfer_from' and transfer_to = '$transfer_to' and transfer_no = '$transfer_no'";
 ...
 if($count==1)
      ...
      $sqlW="SELECT currentQty,USD FROM product Where BrandName = '$NBrandName' and Commodity ='$NCommodity' and code='$code' and Branch ='$transfer_from' and Purchase_order_No ='$txtHintss'";
    ...
    //  var_dump($deliveryUSD);exit();      
     ...
     if($NQty > $rowsW['currentQty']){
      ...
      $sql="SELECT balanceTransfer,balanceDelivery,balanceQty,USD,Qty,balanceUSD FROM product Where BrandName = '$NBrandName' and Commodity ='$NCommodity' and code='$code' and Branch ='$transfer_from' and Purchase_order_No ='$txtHintss'";
      $result=mysqli_query($con ,$sql); 
      $rows = $result->fetch_assoc();
      $balanceTransfers = $rows['balanceTransfer'] + $NQty;
     
      $sql = " UPDATE product SET balanceTransfer ='$balanceTransfers' Where BrandName = '$NBrandName' and Commodity ='$NCommodity' and code='$code' and Branch ='$transfer_from' and Purchase_order_No ='$txtHintss'"; 
      // echo $sql;
      mysqli_query($con ,$sql);

      $sqlsss="SELECT balanceDelivery,balanceTransfer,balanceQty,USD,Qty,balanceUSD,currentQty FROM product Where BrandName = '$NBrandName' and Commodity ='$NCommodity' and code='$code' and Branch ='$transfer_from' and Purchase_order_No ='$txtHintss'";
      ...
      $sql = " UPDATE product SET balanceUSD ='$balanceUSDs' Where BrandName = '$NBrandName' and Commodity ='$NCommodity' and code='$code' and Branch ='$transfer_from' and Purchase_order_No ='$txtHintss'"; 
      // echo $sql;
      mysqli_query($con ,$sql);
      ...
      $sqlpupdate = "UPDATE product SET balanceQty='$remain_balanceQty',currentQty ='$remain_currentQty' Where BrandName = '$NBrandName' and Commodity ='$NCommodity' and code='$code' and Branch ='$transfer_from' and Purchase_order_No ='$txtHintss'";  
   ...
   $returnQty=0;
   $sqlda="INSERT INTO transfer(transfer_from,transfer_to,BrandName,Commodity,code,Type,Qty,transferUSD,PL,Remark_Item,transfer_date,transfer_no,Creator,CreateTime) VALUES ('$transfer_from','$transfer_to','$NBrandName','$NCommodity','$code','$NType','$NQty','$transferUSD','$txtHintss','$NRemark','$transfer_date','$transfer_no','$LUser','$CreateTime')";
   mysqli_query($con,$sqlda);    
                ...
                VALUES ('$input_ID','$transfer_from','','$NBrandName','','$NCommodity','','$code','','$NRemark','','$transfer_date','','$transfer_no','','$NQty','','$txtHintss','','$NType','','$transfer_to','','$CreateTime','$LUser','$status')";      
                    ...
                    $sqlp="SELECT * FROM product Where BrandName = '$NBrandName' and Commodity ='$NCommodity' and Branch ='$transfer_from' and Purchase_order_No ='$txtHintss'";
