...
$sql="SELECT Distinct Purchase_order_No FROM product Where Commodity='$CommodityN' and BrandName='$BrandNameN' and Branch='$Location'";
    ...
    print'&nbsp&nbsp<select onchange="fncCheckRemainStock(this,\''.$rowNum.'\')" name="NPL[]" id="NPL'.$rowNum.'"style="width:10%;height:30px;background:#f2f2f2;font-size:10px;" required="required" readonly>';
