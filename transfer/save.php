...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    $Ntransfer_no = mysqli_real_escape_string($con,$_POST['Ntransfer_no'][$row]); 
     ...
     // for product end
      ...
      Where BrandName = '$BrandName' and Commodity ='$Commoditys' and Branch ='$transfer_from' and Purchase_order_No ='$PL' and transfer_no='$Ntransfer_no'";
        ...
        $sql="SELECT currentQty,USD FROM product 
      Where BrandName = '$BrandName' and Commodity ='$Commoditys' and Branch ='$transfer_from' and Purchase_order_No ='$PL' AND ( transfer_no IS NULL OR transfer_no='')"; 
      }
      $result=mysqli_query($con ,$sql); 
     ...
     if( $Ntransfer_no != ''){
       $row_data[]="('$transfer_from','$transfer_to','$BrandName','$Commoditys','$code','$Type','$Qty','$transferUSD','$PL','$NRemark','$transfer_date','$transfer_no','$LUser','$CreateTime','$Ntransfer_no')";
     }else{
       $row_data[]="('$transfer_from','$transfer_to','$BrandName','$Commoditys','$code','$Type','$Qty','$transferUSD','$PL','$NRemark','$transfer_date','$transfer_no','$LUser','$CreateTime',NULL)";    
     }
    ...
    if( $Qty > $sum){
        ...
        $sqlp="SELECT * FROM product Where BrandName = '$BrandName' and Commodity ='$Commoditys' and Branch ='$transfer_from' and Purchase_order_No ='$PL' and transfer_no='$Ntransfer_no'";
          ...
          $sqlp="SELECT * FROM product Where BrandName = '$BrandName' and Commodity ='$Commoditys' and Branch ='$transfer_from' and Purchase_order_No ='$PL' AND ( transfer_no IS NULL OR transfer_no='')"; 
        }
       ...
       // $remain_balanceUSD =  $rowp['USD'] * ( $Qty +  $rowp['balanceDelivery'] ); 
        ...
        $sqlpupdate = "UPDATE product SET balanceQty='$remain_balanceQty',currentQty ='$remain_currentQty',balanceUSD='$remain_balanceUSD',balanceTransfer='$balanceTransfer' Where BrandName = '$BrandName' and Commodity ='$Commoditys' and Branch ='$transfer_from' and Purchase_order_No ='$PL' and transfer_no='$Ntransfer_no'";  
          ...
          $sqlpupdate = "UPDATE product SET balanceQty='$remain_balanceQty',currentQty ='$remain_currentQty',balanceUSD='$remain_balanceUSD',balanceTransfer='$balanceTransfer' Where BrandName = '$BrandName' and Commodity ='$Commoditys' and Branch ='$transfer_from' and Purchase_order_No ='$PL' AND ( transfer_no IS NULL OR transfer_no='')";   
        }
      ...
      $i += 1;
        ...
        //end
        $sql = 'INSERT INTO transfer(transfer_from,transfer_to,BrandName,Commodity,code,Type,Qty,transferUSD,PL,Remark_Item,transfer_date,transfer_no,Creator,CreateTime,ptransfer_no) VALUES '.implode
      (',', $row_data);
