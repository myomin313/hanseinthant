...
// output headers so that the file is downloaded rather than displayed
 ...
 fputcsv($output,  array('id','Delivery Date','DO No','Location','Customer','Code','BrandName','Commodity','Qty','Delivery USD','Return Qty','Type','Remark_item','PL','Creator','CreateTime'));
