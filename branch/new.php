...
<body style="font-size: 11px;font-family:Tahoma, Geneva, sans-serif;">
             ...
             <?php
                          ...
                          print '<tr><td>Brance Name</td><td> <input type="text" name="branch" id="branch" onblur="fncClearBox()" onKeyUp="Commodity()" value="" style="width:250px;height:30px;" required="required"/></td></tr>';

                          print '<tr><td>Short Terms</td><td> <input type="text" name="short_term" id="short_term"   value="" style="width:250px;height:30px;" required="required"/></td></tr>';
