...
include_once('../config.php');
      ...
      if( $transfer_no != ''){
        ...
        $sqlproduct="SELECT balanceTransfer,Qty,balanceQty,USD,balanceUSD,balanceWIP,balanceDelivery,balanceReturn FROM product Where BrandName = '$BrandName' and Commodity ='$Commodity' and code='$code' and Branch ='$Location' and Purchase_order_No ='".$_GET['PL']."' AND ( transfer_no IS NULL OR transfer_no='')";   
      }
      ...
      $sql = " UPDATE product SET  balanceWIP ='$productJob',balanceDelivery ='$productDelivery' Where BrandName = '$BrandName' and Commodity ='$Commodity' and code='$code' and Branch ='$Location' and Purchase_order_No ='".$_GET['PL']."' and transfer_no='".$_GET['transfer_no']."'"; 
        ...
        $sql = " UPDATE product SET  balanceWIP ='$productJob',balanceDelivery ='$productDelivery' Where BrandName = '$BrandName' and Commodity ='$Commodity' and code='$code' and Branch ='$Location' and Purchase_order_No ='".$_GET['PL']."' AND ( transfer_no IS NULL OR transfer_no='')";  
      }
      // echo $sql;
      mysqli_query($con ,$sql); 
      ...
      $sql = " UPDATE product SET  balanceQty ='$remain' Where BrandName = '$BrandName' and Commodity ='$Commodity' and Branch ='$Location' and code='$code' and Purchase_order_No ='".$_GET['PL']."' and transfer_no='".$_GET['transfer_no']."'"; 
        ...
        $sql = " UPDATE product SET  balanceQty ='$remain' Where BrandName = '$BrandName' and Commodity ='$Commodity' and Branch ='$Location' and code='$code' and Purchase_order_No ='".$_GET['PL']."' AND ( transfer_no IS NULL OR transfer_no='')"; 
      }// echo $sql;
      mysqli_query($con ,$sql); 
      ...
      $sqlQ="SELECT * FROM product Where BrandName = '$BrandName' and Commodity ='$Commodity' and Branch ='$Location' and code='$code' and Purchase_order_No ='".$_GET['PL']."' and transfer_no='".$_GET['transfer_no']."' ";
        ...
        $sqlQ="SELECT * FROM product Where BrandName = '$BrandName' and Commodity ='$Commodity' and Branch ='$Location' and code='$code' and transfer_no='' and Purchase_order_No ='".$_GET['PL']."' AND ( transfer_no IS NULL OR transfer_no='')";  
      }
      ...
      $sqlSSaa = " UPDATE product SET  currentQty ='$currentQty' Where BrandName = '$BrandName' and Commodity ='$Commodity' and code='$code' and Branch ='$Location' and Purchase_order_No ='".$_GET['PL']."' and transfer_no='".$_GET['transfer_no']."'"; 
        ...
        $sqlSSaa = " UPDATE product SET  currentQty ='$currentQty' Where BrandName = '$BrandName' and Commodity ='$Commodity' and code='$code' and Branch ='$Location' and Purchase_order_No ='".$_GET['PL']."' AND ( transfer_no IS NULL OR transfer_no='')";   
      }
      //   echo $sqlSSaa;
      ...
      $sql = " UPDATE product SET  balanceUSD ='$balanceUSD' where BrandName = '$BrandName' and Commodity ='$Commodity'  and code='$code' and Branch ='$Location' and Purchase_order_No ='".$_GET['PL']."' and transfer_no='".$_GET['transfer_no']."'"; 
        ...
        $sql = " UPDATE product SET  balanceUSD ='$balanceUSD' where BrandName = '$BrandName' and Commodity ='$Commodity'  and code='$code' and Branch ='$Location'  and Purchase_order_No ='".$_GET['PL']."' AND ( transfer_no IS NULL OR transfer_no='')"; 
      }
      //   echo $sql;
      mysqli_query($con ,$sql);
   ...
   echo"<script>alert('Successfully Deleted');</script>"; 
    echo "<script type='text/javascript'>window.top.location='detail.php?ID=$okyaku&DO=$DO_No';</script>";exit;	   	
      ...
      $sql = " UPDATE product SET  balanceDelivery ='$nojob' Where BrandName = '$BrandName' and Commodity ='$Commodity' and code='$code' and Branch ='$Location' and Purchase_order_No ='".$_GET['PL']."' and transfer_no='".$_GET['transfer_no']."'"; 
        ...
        $sql = " UPDATE product SET  balanceDelivery ='$nojob' Where BrandName = '$BrandName' and Commodity ='$Commodity' and code='$code' and Branch ='$Location' and Purchase_order_No ='".$_GET['PL']."' AND ( transfer_no IS NULL OR transfer_no='')";  
      } // echo $sql;
      mysqli_query($con ,$sql); 
      ...
      $sqlproducts="SELECT balanceTransfer,Qty,balanceQty,USD,balanceUSD,balanceWIP,balanceDelivery,balanceReturn FROM product Where BrandName = '$BrandName' and Commodity ='$Commodity' and code='$code' and Branch ='$Location' and Purchase_order_No ='".$_GET['PL']."' and transfer_no='".$_GET['transfer_no']."'";
        ...
        $sqlproducts="SELECT balanceTransfer,Qty,balanceQty,USD,balanceUSD,balanceWIP,balanceDelivery,balanceReturn FROM product Where BrandName = '$BrandName' and Commodity ='$Commodity' and code='$code' and Branch ='$Location' and Purchase_order_No ='".$_GET['PL']."' AND ( transfer_no IS NULL OR transfer_no='')";  
      }
      ...
      $sql = " UPDATE product SET  balanceQty ='$remains' Where BrandName = '$BrandName' and Commodity ='$Commodity' and code='$code' and Branch ='$Location' and Purchase_order_No ='".$_GET['PL']."' and transfer_no='".$_GET['transfer_no']."'"; 
        ...
        $sql = " UPDATE product SET  balanceQty ='$remains' Where BrandName = '$BrandName' and Commodity ='$Commodity' and code='$code' and Branch ='$Location' and Purchase_order_No ='".$_GET['PL']."' AND ( transfer_no IS NULL OR transfer_no='')"; 
      }// echo $sql;
      mysqli_query($con ,$sql);     
      ...
      $sqlQs="SELECT * FROM product Where BrandName = '$BrandName' and Commodity ='$Commodity' and code='$code' and Branch ='$Location' and Purchase_order_No ='".$_GET['PL']."' and transfer_no='".$_GET['transfer_no']."'";
        ...
        $sqlQs="SELECT * FROM product Where BrandName = '$BrandName' and Commodity ='$Commodity' and code='$code' and Branch ='$Location' and Purchase_order_No ='".$_GET['PL']."' AND ( transfer_no IS NULL OR transfer_no='')";  
      }
      ...
      $sqlSS = " UPDATE product SET  currentQty ='$currentQtys' Where BrandName = '$BrandName' and Commodity ='$Commodity' and code='$code' and Branch ='$Location' and Purchase_order_No ='".$_GET['PL']."' and transfer_no='".$_GET['transfer_no']."'"; 
        ...
        $sqlSS = " UPDATE product SET  currentQty ='$currentQtys' Where BrandName = '$BrandName' and Commodity ='$Commodity' and code='$code' and Branch ='$Location' and Purchase_order_No ='".$_GET['PL']."' AND ( transfer_no IS NULL OR transfer_no='')";  
      }
      //   echo $sql;
      ...
      $sql = " UPDATE product SET  balanceUSD='$balanceUSDs' Where BrandName = '$BrandName' and Commodity ='$Commodity' and code='$code' and Branch ='$Location' and Purchase_order_No ='".$_GET['PL']."' and transfer_no='".$_GET['transfer_no']."'"; 
        ...
        $sql = " UPDATE product SET  balanceUSD='$balanceUSDs' Where BrandName = '$BrandName' and Commodity ='$Commodity' and code='$code' and Branch ='$Location' and Purchase_order_No ='".$_GET['PL']."' AND ( transfer_no IS NULL OR transfer_no='')";   
      }
      //   echo $sql;
      mysqli_query($con ,$sql);  
