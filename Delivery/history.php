              ...
              <tr class="tr_header" style="background-color:#3385ff;font-family:Tahoma, Geneva, sans-serif;font-size: 12px;">
                ...
                // echo $_POST['users'];
                  if (isset($_POST['users'])) {
                   ...
                   LEFT JOIN brandname b  ON delivery_history.BrandName= b.id 
                   LEFT JOIN commodity c  ON delivery_history.Commodity= c.id
                   LEFT JOIN brandname ob ON delivery_history.OBrandName= ob.id 
                   LEFT JOIN commodity oc ON delivery_history.OCommodity= oc.id
                    WHERE 1=1 ";
                  // echo $sqls;
