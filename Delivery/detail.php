...
function removeRow(rnum) {
  jQuery('#rowNum'+rnum).remove();
     ...
     function save(rowNum)
    {
       ...
       window.location.href = "updatenew.php?id="+encodeURIComponent(rowNum)+"&LUser="+encodeURIComponent(LUser)+"&okyaku="+encodeURIComponent(okyaku)+"&Location="+encodeURIComponent(Location)+"&Delivery_date="+encodeURIComponent(Delivery_date)+"&DO_No="+encodeURIComponent(DO_No)+"&dep_name="+encodeURIComponent(dep_name)+"&JOB_No="+encodeURIComponent(JOB_No)+"&NBrandName="+encodeURIComponent(NBrandName)+"&NCommodity="+encodeURIComponent(NCommodity)+"&code="+encodeURIComponent(code)+"&NType="+encodeURIComponent(NType)+"&NQty="+encodeURIComponent(NQty)+"&txtHintss="+encodeURIComponent(txtHintss)+"&Ntransfer_no="+encodeURIComponent(Ntransfer_no)+"&NRemark="+encodeURIComponent(NRemark)+""; 
...
<script>
    function showCommo(str) {
      ...
      var NDO_No=document.getElementById("DO_No").value+""+document.getElementById("dep_name").value;
...
<script>
    function showPl(rownum) {
      var Brand=document.getElementById("NBrandName"+rowNum).value;
      var Location=document.getElementById("Location").value;
      var transfer_no=document.getElementById("Ntransfer_no"+rowNum).value;
      var code=document.getElementById("code"+rowNum).value;
      var Commodity=document.getElementById("NCommodity"+rowNum).value;
      // alert(Brand);

       $.ajax({
						type: 'GET',
						url: 'get_pl.php',
						data: {BrandName:Brand,Location:Location,transfer_no:transfer_no,code:code,Commodity:Commodity},
						success: function(data){
							// $("#processing").hide();
							// $("#person-data").html(data);
                             // $("#txtHintss"+rowNum).html(data);
                             document.getElementById("txtHintss"+rowNum).innerHTML =data;
						}
					});
     ...
     $pieces = explode($url,$row['DO_No'], 2);
      $ssurl        = $url;
        ...
        //     }
          ...
          print '<tr><td>DO.No </td><td> <input type="text" name="DO_No" id="DO_No" value="' .$pieces[0]. '" style="width:10%;height:30px;font-size:10px;"/>';
          ...
          print '<input type="hidden" name="oldBranch" id="oldBranch" value="' . $row['Location']. '" style="width:20%;height:30px;background:#f2f2f2;font-size:10px;" readonly="readonly"/>';
          print '<input type="hidden" name="oldCustomer" id="oldCustomer" value="' . $myID. '" style="width:20%;height:30px;background:#f2f2f2;font-size:10px;" readonly="readonly"/>';
          print '<input type="hidden" name="oldDO_No" id="oldDO_No" value="' . $DO. '" style="width:20%;height:30px;background:#f2f2f2;font-size:10px;" readonly="readonly"/>';
        ...
        ON co.id= d.code
        JOIN brandname
        ON d.BrandName= brandname.id
        JOIN commodity
        ON d.Commodity= commodity.id 
        WHERE  d.Customer ='$myID' AND d.DO_No='$DO'";
        ...
        $i=0;
        while($row = mysqli_fetch_array($result)) {
           print'<input type="checkbox" name="deliveryid" id="id" value="' . $row["id"] .'">';
          ...
          print '&nbsp<input type="text" name="transfer_no[]" id="transfer_no'. $row["id"].'" value="'. htmlspecialchars($row["transfer_no"], ENT_COMPAT).'" style="width:10%;height:30px;background:#f2f2f2;font-size:10px;" readonly/>';           
...
// <span  class="warn warning"></span><span style="color:#ff8566;">This Update is not for Commodity.</span></td></tr>'; 
  ...
  <script type="text/javascript">
        function update(id)
    {
       ...
       var Delivery_date= encodeURIComponent(document.getElementById('Delivery_date').value);
       var DO_No= encodeURIComponent(document.getElementById('DO_No').value);
       var dep_name= encodeURIComponent(document.getElementById('dep_name').value);
       var JOB_No= encodeURIComponent(document.getElementById('JOB_No').value);
       ...
       window.location.href = "update.php?id="+id+"&LUser="+LUser+"&okyaku="+okyaku+"&Location="+Location+"&Delivery_date="+Delivery_date+"&DO_No="+DO_No+"&dep_name="+dep_name+"&JOB_No="+JOB_No+"&BrandName="+BrandName+"&Commodity="+Commodity+"&code="+code+"&Type="+Type+"&Qty="+Qty+"&PL="+PL+"&Remark_item="+Remark_item+""; 
  ...
  <script type="text/javascript">
        function Delete(id)
    {
       ...
       var Qty= encodeURIComponent(document.getElementById('Qty'+id).value);
       var PL= encodeURIComponent(document.getElementById('PL'+id).value);
       var transfer_no= encodeURIComponent(document.getElementById('transfer_no'+id).value);
       var Remark_item= encodeURIComponent(document.getElementById('Remark_item'+id).value);    

       window.location.href = "remove.php?id="+id+"&LUser="+LUser+"&okyaku="+okyaku+"&Location="+Location+"&Delivery_date="+Delivery_date+"&DO_No="+DO_No+"&dep_name="+dep_name+"&JOB_No="+JOB_No+"&BrandName="+BrandName+"&Commodity="+Commodity+"&code="+code+"&Type="+Type+"&Qty="+Qty+"&PL="+PL+"&transfer_no="+transfer_no+"&Remark_item="+Remark_item+""; 
  ...
  <script type="text/javascript">
    ...
    $('.deleteitemall').on('click',function(){
      var deliveryid = [];
        $("input:checkbox[name=deliveryid]:checked").each(function(){
            deliveryid.push($(this).val());
          });
       var LUser= document.getElementById('LUser').value;
       var okyaku= document.getElementById('okyaku').value;
       var Location= document.getElementById('Location').value;
       ...
       var LUser= document.getElementById('LUser').value;
          ...
          window.location.href = "removeall.php?ids="+deliveryid+"&LUser="+LUser+"&okyaku="+okyaku+"&Location="+Location+"&DO_No="+DO_No+"&dep_name="+dep_name+"&JOB_No="+JOB_No+"";
