...
<script>
    ...
    //   alert(Location);
        if (str == "") {
            ...
            xmlhttp.open("GET","get-data.php?q="+encodeURIComponent(str)+"&rowNum="+encodeURIComponent(rowNum)+"&CommodityN="+encodeURIComponent(CommodityN)+"&BrandNameN="+encodeURIComponent(BrandNameN)+"&JOB_Noss="+encodeURIComponent(JOB_Noss)+"&Location="+encodeURIComponent(Location)+"",true);
            xmlhttp.send();
        }
    }
</script> 
...
<div id="outer-container" >
    <div id="scrollable">
        ...
        print '<tr><td style="width:7%;">Branch</td><td> <select name="Location" id="Location" onchange="showJob(this.value)" style="width:20%;height:30px;" required="required">';
        print'<option value =""></option>';
        ...
        //   }                           
                          ...
                          print '<tr><td>Delivery Date</td><td> <input id="Delivery_date" data-date="" data-date-format="DD/MM/YYYY" type="date" name="Delivery_date" value=""  style="width:20%;height:30px;font-size:11px;" required="required"/></td></tr>'; 
                          print '<tr><td>DO.No</td><td> <input type="text"  name="DO_No" id="DO_No" value=""  style="width:10%;height:30px;" required="required"  onKeyUp="checkDo()"/>';
