<?php
      ...
      if($Ntransfer_no != ''){
         $sqlA = "SELECT DISTINCT BrandName,Commodity,PL FROM delivery WHERE BrandName ='$NBrandName' and Commodity= '$NCommodity' and code='$code' and PL = '$txtHintss' and Location= '$Location' and Customer = '$okyaku' and DO_No = '$DO_No' and transfer_no='$Ntransfer_no'";
      }else{
        $sqlA = "SELECT DISTINCT BrandName,Commodity,PL FROM delivery WHERE BrandName ='$NBrandName' and Commodity= '$NCommodity' and code='$code' and PL = '$txtHintss' and Location= '$Location' and Customer = '$okyaku' and DO_No = '$DO_No' and transfer_no IS NULL";
      } 
 ...
 if($count==1)
    ...
    if($Ntransfer_no != ''){
      ...
      $sqlW="SELECT currentQty,USD FROM product Where BrandName = '$NBrandName' and Commodity ='$NCommodity' and code='$code' and Branch ='$Location' and Purchase_order_No ='$txtHintss' AND ( transfer_no IS NULL OR transfer_no='')";
    }
     ...
     if($NQty > $rowsW['currentQty']){
      ...
      if($Ntransfer_no != ''){
       $sql = " UPDATE product SET  balanceWIP ='$sumJOB' Where BrandName = '$NBrandName' and Commodity ='$NCommodity' and code='$code' and Branch ='$Location' and transfer_no='$Ntransfer_no' and Purchase_order_No ='$txtHintss'";     
        ...
        $sql = " UPDATE product SET  balanceWIP ='$sumJOB' Where BrandName = '$NBrandName' and Commodity ='$NCommodity' and code='$code' and Branch ='$Location' and Purchase_order_No ='$txtHintss' AND ( transfer_no IS NULL OR transfer_no='')"; 
      } // echo $sql; 
        mysqli_query($con ,$sql);
      ...
      $sql="SELECT balanceDelivery,balanceQty,USD FROM product Where BrandName = '$NBrandName' and Commodity ='$NCommodity' and code='$code' and Branch ='$Location' and Purchase_order_No ='$txtHintss' and transfer_no='$Ntransfer_no'";
          ...
          $sql="SELECT balanceDelivery,balanceQty,USD FROM product Where BrandName = '$NBrandName' and Commodity ='$NCommodity' and code='$code' 
          and Branch ='$Location' and Purchase_order_No ='$txtHintss' AND ( transfer_no IS NULL OR transfer_no='')";  
        }
      $result=mysqli_query($con ,$sql); 
      $rows = $result->fetch_assoc();
       ...
       $sql = " UPDATE product SET  balanceDelivery ='$remain' Where BrandName = '$NBrandName' and Commodity ='$NCommodity' and code='$code' and Branch ='$Location' and Purchase_order_No ='$txtHintss' and transfer_no='$Ntransfer_no'";     
        ...
        $sql = " UPDATE product SET  balanceDelivery ='$remain' Where BrandName = '$NBrandName' and Commodity ='$NCommodity' and 
        code='$code' and Branch ='$Location' and Purchase_order_No ='$txtHintss' AND ( transfer_no IS NULL OR transfer_no='')"; 
       } // echo $sql; 
        mysqli_query($con ,$sql);
      ...
      $sqlQ="SELECT balanceDelivery,balanceQty,USD FROM product Where BrandName = '$NBrandName' and Commodity ='$NCommodity' and code='$code' and Branch ='$Location' and transfer_no='$Ntransfer_no' and Purchase_order_No ='$txtHintss'";
        ...
        $sqlQ="SELECT balanceDelivery,balanceQty,USD FROM product Where BrandName = '$NBrandName' and Commodity ='$NCommodity' and 
        code='$code' and Branch ='$Location' and Purchase_order_No ='$txtHintss' AND ( transfer_no IS NULL OR transfer_no='')";  
      }
      ...
      if($Ntransfer_no != ''){ 
       $sql = " UPDATE product SET  balanceUSD ='$balanceUSD' Where BrandName = '$NBrandName' and Commodity ='$NCommodity' and code='$code' and Branch ='$Location' and transfer_no='$Ntransfer_no' and Purchase_order_No ='$txtHintss'";     
        ...
        $sql = " UPDATE product SET  balanceUSD ='$balanceUSD' Where BrandName = '$NBrandName' and Commodity ='$NCommodity' and code='$code' 
        and Branch ='$Location' and Purchase_order_No ='$txtHintss' AND ( transfer_no IS NULL OR transfer_no='')";
      } // echo $sql; 
        mysqli_query($con ,$sql);
      ...
      $sqld="SELECT balanceTransfer,balanceDelivery,balanceWIP,Qty,balanceReturn FROM product Where BrandName = '$NBrandName' and Commodity ='$NCommodity' and code='$code' and Branch ='$Location' and transfer_no='$Ntransfer_no' and Purchase_order_No ='$txtHintss'";
        ...
        $sqld="SELECT balanceTransfer,balanceDelivery,balanceWIP,Qty,balanceReturn FROM product Where BrandName = '$NBrandName' and Commodity ='$NCommodity' 
        and code='$code' and Branch ='$Location' and Purchase_order_No ='$txtHintss' AND ( transfer_no IS NULL OR transfer_no='')";  
      }
      ...
      $sql = " UPDATE product SET balanceQty ='$balanceQty' Where BrandName = '$NBrandName' and Commodity ='$NCommodity' and code='$code' and Branch ='$Location' and transfer_no='$Ntransfer_no' and Purchase_order_No ='$txtHintss'"; 
        ...
        $sql = " UPDATE product SET balanceQty ='$balanceQty' Where BrandName = '$NBrandName' and Commodity ='$NCommodity' and code='$code'
        and Branch ='$Location' and Purchase_order_No ='$txtHintss' AND ( transfer_no IS NULL OR transfer_no='')";   
      } // echo $sql;
      mysqli_query($con ,$sql);
        // myo min start
       ...
       $sqlmyo = " UPDATE product SET currentQty ='$currentQty' Where BrandName = '$NBrandName' and Commodity ='$NCommodity' and code='$code' and Branch ='$Location' and transfer_no='$Ntransfer_no' and Purchase_order_No ='$txtHintss'"; 
          ...
          $sqlmyo = " UPDATE product SET currentQty ='$currentQty' Where BrandName = '$NBrandName' and Commodity ='$NCommodity' and code='$code' 
          and Branch ='$Location' and Purchase_order_No ='$txtHintss' AND ( transfer_no IS NULL OR transfer_no='')";  
        }
...
$sql="INSERT INTO delivery (Location,Customer,Commodity,BrandName,code,Type,PL,Qty,Delivery_date,DO_No,JOB_No,Remark_item,returnQty,Creator,CreateTime,deliveryUSD) VALUES ('$Location','$okyaku','$NCommodity','$NBrandName','$code','$NType','$txtHintss','$NQty','$Delivery_date','$DO_No','$JOB_No','$NRemark','$returnQty','$LUser','$CreateTime','$deliveryUSD')";
  ...
  mysqli_query($con,$sql);    
      ...
      $sql="SELECT balanceDelivery,balanceQty,USD,Qty,balanceUSD FROM product Where BrandName = '$NBrandName' and Commodity ='$NCommodity' and code='$code' and Branch ='$Location' and  transfer_no='$Ntransfer_no' and Purchase_order_No ='$txtHintss'";
          ...
          $sql="SELECT balanceDelivery,balanceQty,USD,Qty,balanceUSD FROM product Where BrandName = '$NBrandName' and Commodity ='$NCommodity' 
          and code='$code' and Branch ='$Location' and Purchase_order_No ='$txtHintss' AND ( transfer_no IS NULL OR transfer_no='')";
        }
      $result=mysqli_query($con ,$sql); 
      $rows = $result->fetch_assoc();
      ...
      $sql = " UPDATE product SET balanceDelivery ='$balanceDeliverys' Where BrandName = '$NBrandName' and Commodity ='$NCommodity' and code='$code' and Branch ='$Location' and transfer_no='$Ntransfer_no' and Purchase_order_No ='$txtHintss'"; 
        ...
        $sql = " UPDATE product SET balanceDelivery ='$balanceDeliverys' Where BrandName = '$NBrandName' and Commodity ='$NCommodity' and code='$code'
        and Branch ='$Location' and Purchase_order_No ='$txtHintss' AND ( transfer_no IS NULL OR transfer_no='')"; 
      }// echo $sql;
      mysqli_query($con ,$sql);
      
      if($Ntransfer_no != ''){
        $sqlsss="SELECT balanceDelivery,balanceTransfer,balanceReturn,balanceQty,USD,Qty,balanceUSD FROM product Where BrandName = '$NBrandName' and Commodity ='$NCommodity' and code='$code' and Branch ='$Location' and transfer_no='$Ntransfer_no' and Purchase_order_No ='$txtHintss'";
      }else{
        $sqlsss="SELECT balanceDelivery,balanceTransfer,balanceReturn,balanceQty,USD,Qty,balanceUSD FROM product Where BrandName = '$NBrandName' and Commodity ='$NCommodity' 
        and code='$code' and Branch ='$Location' and Purchase_order_No ='$txtHintss' AND ( transfer_no IS NULL OR transfer_no='')";  
      }
      ...
      $rowsss = $resultsss->fetch_assoc();
       ...
       $batd = $rowsss['balanceTransfer'] +  ( $rowsss['balanceDelivery'] - $rowsss['balanceReturn'] );
      ...
      $sql = " UPDATE product SET balanceUSD ='$balanceUSDs' Where BrandName = '$NBrandName' and Commodity ='$NCommodity' and code='$code' and Branch ='$Location' and transfer_no='$Ntransfer_no' and Purchase_order_No ='$txtHintss'"; 
        ...
        $sql = " UPDATE product SET balanceUSD ='$balanceUSDs' Where BrandName = '$NBrandName' and Commodity ='$NCommodity' and 
        code='$code' and Branch ='$Location' and Purchase_order_No ='$txtHintss' AND ( transfer_no IS NULL OR transfer_no='')";
       } // echo $sql;
      mysqli_query($con ,$sql);
      ...
      if($Ntransfer_no != ''){
        ...
        $sqlh="SELECT balanceTransfer,balanceDelivery,balanceWIP,Qty,balanceReturn FROM product Where BrandName = '$NBrandName' and Commodity ='$NCommodity' 
        and code='$code' and Branch ='$Location' and Purchase_order_No ='$txtHintss' AND ( transfer_no IS NULL OR transfer_no='')";
      }
      ...
      $sql = " UPDATE product SET  balanceQty ='$balanceQty' Where BrandName = '$NBrandName' and Commodity ='$NCommodity' and code='$code' and Branch ='$Location' and transfer_no='$Ntransfer_no' and Purchase_order_No ='$txtHintss'";
        ...
        $sql = " UPDATE product SET  balanceQty ='$balanceQty' Where BrandName = '$NBrandName' and Commodity ='$NCommodity' and code='$code' and Branch ='$Location' 
      ...
      // myo min start
       ...
       $sqlmyo = " UPDATE product SET  currentQty ='$currentQty' Where BrandName = '$NBrandName' and Commodity ='$NCommodity' and code='$code' and Branch ='$Location' and transfer_no='$Ntransfer_no' and Purchase_order_No ='$txtHintss'";
          ...
          $sqlmyo = " UPDATE product SET  currentQty ='$currentQty' Where BrandName = '$NBrandName' and Commodity ='$NCommodity' and code='$code' and Branch ='$Location' and Purchase_order_No ='$txtHintss' AND ( transfer_no IS NULL OR transfer_no='')";
        }
       mysqli_query($con ,$sqlmyo);
       // echo $sql;
       // myo min end
   ...
   $returnQty=0;
      ...
      if($Ntransfer_no != ''){
         ...
         $sql="INSERT INTO delivery (Location,Customer,Commodity,BrandName,code,Type,PL,Qty,Delivery_date,DO_No,JOB_No,Remark_item,returnQty,Creator,CreateTime,deliveryUSD,transfer_no) VALUES ('$Location','$okyaku','$NCommodity','$NBrandName','$code','$NType','$txtHintss','$NQty','$Delivery_date','$DO_No','$JOB_No','$NRemark','$returnQty','$LUser','$CreateTime','$deliveryUSD',NULL)";
          mysqli_query($con,$sql);   
       }
