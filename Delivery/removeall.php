...
include_once('../config.php');
      ...
      if( $Otransfer_no != ''){
        ...
        $sqlproduct="SELECT balanceTransfer,Qty,balanceQty,USD,balanceUSD,balanceWIP,balanceDelivery,balanceReturn FROM product Where BrandName = '$OBrandName' and Commodity ='$OCommodity' and code='$Ocode' and Branch ='$Location' and Purchase_order_No ='$OPL' AND ( transfer_no IS NULL OR transfer_no='')";
      }
    ...
    if($Otransfer_no != ''){
      ...
      $sql = " UPDATE product SET  balanceWIP ='$productJob',balanceDelivery ='$productDelivery' Where BrandName = '$OBrandName' and Commodity ='$OCommodity' 
      and code='$Ocode' and Branch ='$Location' and Purchase_order_No ='$OPL' AND ( transfer_no IS NULL OR transfer_no='')"; 
    } // echo $sql;
      mysqli_query($con ,$sql); 
      ...
      $sql = " UPDATE product SET  balanceWIP ='$productJob',balanceDelivery ='$productDelivery' Where BrandName = '$OBrandName' and Commodity ='$OCommodity' and code='$Ocode' and Branch ='$Location' and Purchase_order_No ='$OPL' and transfer_no='$Otransfer_no'"; 
        ...
        $sql = " UPDATE product SET  balanceWIP ='$productJob',balanceDelivery ='$productDelivery' Where BrandName = '$OBrandName' and Commodity ='$OCommodity' and code='$Ocode' and Branch ='$Location' 
        and Purchase_order_No ='$OPL' AND ( transfer_no IS NULL OR transfer_no='')"; 
      }
      // echo $sql;
      mysqli_query($con ,$sql); 
      ...
      $sql = " UPDATE product SET  balanceQty ='$remain' Where BrandName = '$OBrandName' and Commodity ='$OCommodity' and code='$Ocode' and Branch ='$Location' and Purchase_order_No ='$OPL' and transfer_no='$Otransfer_no'"; 
        ...
        $sql = " UPDATE product SET  balanceQty ='$remain' Where BrandName = '$OBrandName' and Commodity ='$OCommodity' and code='$Ocode' and Branch ='$Location' 
        and Purchase_order_No ='$OPL' AND ( transfer_no IS NULL OR transfer_no='')"; 
       } // echo $sql;
      mysqli_query($con ,$sql); 
      if( $Otransfer_no != ''){
      $sqlQ="SELECT * FROM product Where BrandName = '$OBrandName' and Commodity ='$OCommodity' and code='$Ocode' and Branch ='$Location' and Purchase_order_No ='$OPL' and transfer_no='$Otransfer_no'";
        ...
        $sqlQ="SELECT * FROM product Where BrandName = '$OBrandName' and Commodity ='$OCommodity' and code='$Ocode' and Branch ='$Location' 
        and Purchase_order_No ='$OPL' AND ( transfer_no IS NULL OR transfer_no='')"; 
      }
      ...
      $sqlSSaa = " UPDATE product SET  currentQty ='$currentQty' Where BrandName = '$OBrandName' and Commodity ='$OCommodity' and code='$Ocode' and Branch ='$Location' and Purchase_order_No ='$OPL' and transfer_no='$Otransfer_no'"; 
        ...
        $sqlSSaa = " UPDATE product SET  currentQty ='$currentQty' Where BrandName = '$OBrandName' and Commodity ='$OCommodity' and code='$Ocode' 
        and Branch ='$Location' and Purchase_order_No ='$OPL' AND ( transfer_no IS NULL OR transfer_no='')";  
      }
      //   echo $sqlSSaa;
      ...
      $sql = " UPDATE product SET  balanceUSD ='$balanceUSD' where BrandName = '$OBrandName' and Commodity ='$OCommodity' and code='$Ocode' and Branch ='$Location' and Purchase_order_No ='$OPL' and transfer_no='$Otransfer_no'"; 
        ...
        $sql = " UPDATE product SET  balanceUSD ='$balanceUSD' where BrandName = '$OBrandName' and Commodity ='$OCommodity' and code='$Ocode' and Branch ='$Location' 
        and Purchase_order_No ='$OPL' AND ( transfer_no IS NULL OR transfer_no='')";  
      }
      //   echo $sql;
      mysqli_query($con ,$sql);
...
$sql="DELETE FROM delivery where BrandName = '$OBrandName' and Commodity ='$OCommodity' and code='$Ocode' and Location ='$Location'and  id='$id' AND Customer='$okyaku' AND DO_No='$DO_No' ";
  ...
  // echo "<script type='text/javascript'>window.top.location='detail.php?ID=$okyaku&DO=$DO_No';</script>";exit;     
      ...
      $sql = " UPDATE product SET  balanceDelivery ='$nojob' Where BrandName = '$OBrandName' and Commodity ='$OCommodity' and code='$Ocode' and Branch ='$Location' and Purchase_order_No ='$OPL' and transfer_no='$Otransfer_no'"; 
        ...
        $sql = " UPDATE product SET  balanceDelivery ='$nojob' Where BrandName = '$OBrandName' and Commodity ='$OCommodity' and code='$Ocode' and Branch ='$Location' 
        and Purchase_order_No ='$OPL' AND ( transfer_no IS NULL OR transfer_no='')";
      }// echo $sql;
      mysqli_query($con ,$sql);  
      if( $Otransfer_no != ''){  
      ...
      $sql = " UPDATE product SET  balanceQty ='$remains' Where BrandName = '$OBrandName' and Commodity ='$OCommodity' and code='$Ocode' and Branch ='$Location' and Purchase_order_No ='$OPL' and transfer_no='$Otransfer_no'"; 
        ...
        $sql = " UPDATE product SET  balanceQty ='$remains' Where BrandName = '$OBrandName' and Commodity ='$OCommodity' and code='$Ocode' and Branch ='$Location' 
        and Purchase_order_No ='$OPL' AND ( transfer_no IS NULL OR transfer_no='')";
      }// echo $sql;
      mysqli_query($con ,$sql);     
      ...
      $sqlQs="SELECT * FROM product Where BrandName = '$OBrandName' and Commodity ='$OCommodity' and code='$Ocode' and Branch ='$Location' and Purchase_order_No ='$OPL' and transfer_no='$Otransfer_no'";
        ...
        $sqlQs="SELECT * FROM product Where BrandName = '$OBrandName' and Commodity ='$OCommodity' and code='$Ocode' and Branch ='$Location'  and Purchase_order_No ='$OPL' AND ( transfer_no IS NULL OR transfer_no='')";
      }
      ...
      $sqlSS = " UPDATE product SET  currentQty ='$currentQtys' Where BrandName = '$OBrandName' and Commodity ='$OCommodity' and code='$Ocode' and Branch ='$Location' and Purchase_order_No ='$OPL' and transfer_no='$Otransfer_no'"; 
        ...
        $sqlSS = " UPDATE product SET  currentQty ='$currentQtys' Where BrandName = '$OBrandName' and Commodity ='$OCommodity' and code='$Ocode'  and Branch ='$Location' and Purchase_order_No ='$OPL' AND ( transfer_no IS NULL OR transfer_no='')";  
      }
       //   echo $sql;
    ...
    if( $Otransfer_no != ''){
      ...
      $sql = " UPDATE product SET  balanceUSD='$balanceUSDs' Where BrandName = '$OBrandName' and Commodity ='$OCommodity' and code='$Ocode' and Branch ='$Location'  and Purchase_order_No ='$OPL' AND ( transfer_no IS NULL OR transfer_no='')";
    }
      //   echo $sql;
      mysqli_query($con ,$sql);  
