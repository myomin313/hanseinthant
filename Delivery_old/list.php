...
//Where d.Location='Mandalay Show Room'
                ...
                // develop by Winsan
                            ...
                            if (isset($_POST['keyword'])) {
                              ...
                              $sqlA =$sqlA." AND (customer.CustomerName LIKE '%$keyword%' OR delivery.BrandName LIKE '%$keyword%'OR delivery.Commodity LIKE '%$keyword%'OR delivery.JOB_No LIKE '%$keyword%'OR delivery.DO_No LIKE '%$keyword%'OR delivery.Location LIKE '%$keyword%'OR delivery.PL LIKE '%$keyword%' )";

                            }  
                        
                            if ($_GET['namelist'] <> ''){
                                $sqlA =$sqlA." AND (c.CustomerName= '".$_GET['namelist']."' OR d.BrandName= '".$_GET['namelist']."'OR d.Commodity= '".$_GET['namelist']."'OR d.JOB_No= '".$_GET['namelist']."'OR d.DO_No= '".$_GET['namelist']."'OR d.Location= '".$_GET['namelist']."'OR d.PL= '".$_GET['namelist']."')";
