...
<div class="topnav" id="test">
     ...
     print '<a href="../Rate/list.php?namelist=&year=&month=&day="  style="'.($actual_link == "https://hanseinthant.com/Rate/new.php"? "  background-color: white;color:black; height:35px;":'').'">Rate</a>';
      ...
      <?php  print '<a href="../transfer/list.php?namelist=&year=&month=&day="  style="'.($actual_link == "https://hanseinthant.com/transfer/new.php"? "  background-color: white;color:black; height:35px;":'').'">Transfer</a>';?>
      ...
      <a href="../logout.php?"  style="margin-left:36%;" ><img src = "../image/log.png" width="26px"; height="25px;" ></a>
