...
include_once('../config.php');
 ...
 fputcsv($output,  array('id','Return date','Return no','To','Customer','DO No','Code','BrandName','Commodity','Qty','Type','Remark_item','Creator','CreateTime'));  
...
$sWhere = "";
$sqls=" SELECT returns.id,returns.Return_date,returns.Return_no,branch.branch,customer.CustomerName,returns.Do_No,code.code,brandname.brandname as BrandName,commodity.commodity as Commodity,returns.Qty,returns.Type,returns.Remarks_item,returns.Creator,returns.CreateTime FROM returns 
                  LEFT JOIN customer
