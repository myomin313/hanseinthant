...
// $q2 = $con->query($setutf7);
      ...
      $PL=$_GET['PL']; 
                ...
                //   echo $sql;                  
                  ...
                  $sqlproduct="SELECT balanceReturn,USD,balanceUSD,balanceDelivery,balanceWIP,Qty FROM product Where BrandName = '$OBrandName' and Commodity ='$OCommodity' and code='$Ocode' and Branch ='$Odepartment' and Purchase_order_No ='$PL'";

                  $resultproduct=mysqli_query($con ,$sqlproduct); 
                  $product = $resultproduct->fetch_assoc();
                  $balanceReturn = $product['balanceReturn'] - $_GET['quan'];

                 $sql = " UPDATE product SET  balanceReturn ='$balanceReturn' Where BrandName = '$OBrandName' and Commodity ='$OCommodity' and code='$Ocode' and Branch ='$Odepartment' and Purchase_order_No ='$PL'";               
                 // echo $sql;
                 mysqli_query($con ,$sql); 
                 
                  $sqlproductA="SELECT balanceTransfer,balanceReturn,USD,balanceUSD,balanceDelivery,balanceWIP,Qty FROM product Where BrandName = '$OBrandName' and Commodity ='$OCommodity' and code='$Ocode' and Branch ='$Odepartment' and Purchase_order_No ='$PL'";
                 ...
                 $sql = " UPDATE product SET balanceUSD='$balanceUSD',balanceQty='$totalQty' Where BrandName = '$OBrandName' and Commodity ='$OCommodity' and code='$Ocode' and Branch ='$Odepartment' and Purchase_order_No ='$PL'";
                 // echo $sql;
                 mysqli_query($con ,$sql); 
                 
                   $sqlA = " UPDATE product SET currentQty='$currentQty' Where BrandName = '$OBrandName' and Commodity ='$OCommodity' and code='$Ocode' and Branch ='$Odepartment' and Purchase_order_No ='$PL'";
             
                 mysqli_query($con ,$sqlA); 
                 
                $sqldelivery="SELECT returnQty FROM delivery Where BrandName = '$OBrandName' and Commodity ='$OCommodity' and code='$Ocode' and Location ='$Odepartment' and PL ='$PL' and DO_No = '$DO_No'";
                $resultdelivery=mysqli_query($con ,$sqldelivery); 
                $delivery = $resultdelivery->fetch_assoc();
                $returnQty = $delivery['returnQty'] - $_GET['quan'];

                 $sql = " UPDATE delivery SET  returnQty ='$returnQty' Where BrandName = '$OBrandName' and Commodity ='$OCommodity' and code='$Ocode' and Location ='$Odepartment' and PL ='$PL' and DO_No = '$DO_No'";
                 // echo $sql;
                 mysqli_query($con ,$sql); 
