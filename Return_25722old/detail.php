...
function removeRow(rnum) {
  jQuery('#rowNum'+rnum).remove();
     ...
     function save(rowNum)
    {
       ...
       window.location.href = "updatenew.php?id="+rowNum+"&LUser="+LUser+"&okyaku="+okyaku+"&DO_No="+DO_No+"&department="+department+"&Return_no="+Return_no+"&Return_date="+Return_date+"&NBrandName="+NBrandName+"&NCommodity="+NCommodity+"&code="+code+"&NType="+NType+"&Qty="+Qty+"&PL="+PL+"&Remarks="+Remarks+""; 
