...
$sWhere = "";
$sql = "SELECT supplier_return.id,supplier_return.Return_date,supplier.SupplierName,supplier_return.PL,supplier_return.BrandName,supplier_return.Commodity,supplier_return.Qty,supplier_return.type,supplier_return.Remark_item,supplier_return.Creator,supplier_return.CreateTime FROM supplier_return 
    LEFT JOIN supplier
