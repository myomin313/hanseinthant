          ...
          <?php
                        ...
                        $LUser = $_SESSION['login_user'];
                          ...
                          print'<tr><td><input type="hidden" name="LUser" id="LUser" value="'.$LUser.'" style="width:250px;height:30px;" /></td></tr>'; 
                           ...
                           print '<tr><td>BrandName</td><td><input type="text"  name="brandname" id="brandname" value="' .htmlspecialchars($row['brandname'], ENT_COMPAT) . '" style="width:250px;height:30px;font-size:10px;"/></td></tr>';
